...
REM ----
REM Elastic Email Dashboard
REM https://elasticemail.com/account/#/start
REM ----

SET NAME_USE=ELASTICEMAIL
...
SET HOST=SMTP.%NAME_USE%.COM
SET PORT=2525
SET USER_ID=matt.lan@btinternet.com
SET AUTHENTICATION_METHOD=2
SET EMAIL_RECEIPENT="Matthew Lancaster <matt.lan@btinternet.com> RoidsRim <rub.rim@gmail.com>"
...
ECHO BODY_PATH_FILE_1
ECHO %BODY_PATH_FILE_1%
SET PASS3=83r9U0nDhw/sL7CfqdklKvpEba73vodcRg5bxXIFW4JmFU55LWMNQRLcZGb2KdaoJsRE273hV2yhiGwyMixG+k9g1+N2ZdSTHnQGETU66m+JrMXsb1JqKTfTOo7wRP4L
