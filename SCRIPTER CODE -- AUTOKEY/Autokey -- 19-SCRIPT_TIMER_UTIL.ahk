...
GITHUB_MIDNIGHT_AND_MIDDAY_TIMER:
	...
	IF GITHUB_SET_GO=TRUE
	{
		...
		IfExist, %FN_VAR%
		{
			Run, %FN_VAR% /GITHUB_MODE_FULL /FROM_EXE_GITHUB_02 /TASKBAR_TRAY_ICON
			; - GITHUB_MODE_ONLY FROM_EXE_GITHUB_02
		}
	}
	...
	IF GOODSYNC_SET_GO=TRUE
	{
		...
		IfExist, %FN_VAR%
		{
			Run, %FN_VAR% /GOODSYNC_MODE /TASKBAR_TRAY_ICON
		}
	}
...
RELOAD_OR_KILL_PATH_ARRAY_SET_NETWORK_ALL_CODE_04_OF_04:
	...
	IFWINNOTEXIST, SCRIPTER\SCRIPTER CODE -- AUTOKEY\BAT_03_PROCESS_KILLER.BAT
		IfExist, %FN_VAR%
		{
			SoundBeep , 2500 , 100
