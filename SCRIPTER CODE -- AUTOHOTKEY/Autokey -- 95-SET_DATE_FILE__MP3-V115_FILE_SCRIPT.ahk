...
SUB_MOVE_TO_DIRECTORY_STRUCTURE_FOLDER:
	...
	Loop, Files, F:\MP3-YX-510_02_TS\V\*.* , R
	{
		...
		IF INSTR(".MP3 .WAV .MP4 .WMV .AVI .MPG .MPEG .FLV .MID .MIDI",OutExtension)
		{
...
RETREIVE_MODIFIED_DATE_SORTED_CONTENT_TO_LIST_FILE:
	...
	FILE_PLAY_SCRIPT_OUT=C:\SCRIPTER\SCRIPTER CODE -- VB 02 VBSCRIPT\VBS 68-FILE LOCATOR -- SCRIPT --%VAR_PLAYER%__#NFS_EX_.TXT
	...
	; FILE_PLAY_SCRIPT_OUT=C:\SCRIPTER\SCRIPTER CODE -- VB 02 VBSCRIPT\VBS 68-FILE LOCATOR -- SCRIPT - MP3-%VAR_PLAYER%_FILE_SCRIPT_#NFS_EX_.TXT
