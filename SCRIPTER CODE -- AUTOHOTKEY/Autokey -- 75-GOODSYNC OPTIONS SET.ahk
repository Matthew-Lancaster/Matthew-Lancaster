...
TIMER_SUB_GOODSYNC_OPTIONS:
	...
	IF HWND_2=%HWND_1%
	{
		...
		; -----------------------------------------------------------
		WinGetTitle OutputVar_3,ahk_id %HWND_1%
		NOT_GSDATA_FOLDER_SET_GO_1_L=
		NOT_GSDATA_FOLDER_SET_GO_1_R=
		IF INSTR(OutputVar_3,"D DSC EVER ONE DRIVE 20")>0 
			NOT_GSDATA_FOLDER_SET_GO_1_R=TRUE
		...
		IF NOT_GSDATA_FOLDER_SET_GO_1_R
			NOT_GSDATA_FOLDER_SET_GO_1_L=TRUE
		...
		NOT_GSDATA_FOLDER_SET_GO_4_L=
		NOT_GSDATA_FOLDER_SET_GO_4_R=
		IF INSTR(OutputVar_4,"E DESKTOP")>0 
			NOT_GSDATA_FOLDER_SET_GO_4_R=TRUE
