...
RUN_CHKDSK_FOR_MEDIA_CAR_V_DRIVE_3:
	...
	PATH_1_BAT=C:\SCRIPTOR DATA\SCRIPTER CODE -- AUTOHOTKEY\Autokey -- 85-CHECK DISK CHKDSK AR MEDIA CARD_BAT_#NFS_EX_.BAT
	FILE_1_BAT=Autokey -- 85-CHECK DISK CHKDSK AR MEDIA CARD_BAT_#NFS_EX_.BAT
	...
	FILE_1_BAT=%PATH_1_BAT%%FILE_1_BAT%
	...
	IFWINNOTEXIST Autokey -- 85-CHECK DISK CHKDSK AR MEDIA CARD ahk_class ConsoleWindowClass
	{
		...
		; IF INSTR(Command_Params,"NOT_SHOW")=0 
			; RunWAIT, %comspec% /C "START /B /WAIT "Autokey -- 85-CHECK DISK CHKDSK AR MEDIA CARD.ahk" "%FILE_1_BAT%"" ; ,, HIDE
		; IF INSTR(Command_Params,"NOT_SHOW")>0 
			; RunWAIT, %comspec% /C "START /B /WAIT "Autokey -- 85-CHECK DISK CHKDSK AR MEDIA CARD.ahk" "%FILE_1_BAT%"" ,, HIDE
