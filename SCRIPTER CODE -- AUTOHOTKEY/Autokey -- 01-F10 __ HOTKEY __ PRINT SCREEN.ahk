...
*~H::
	...
	; {
		...
		SETTIMER TIMER_SELECT_20_PHOTO_WITH_HOTKEY_H_01,400
	; }
RETURN
#ifwinactive
; -------------------------------------------------------------------
TIMER_SELECT_20_PHOTO_WITH_HOTKEY_H_01:
	...
	IF TIMER_SELECT_20_PHOTO_WITH_HOTKEY_H_COUNT>4000 
	{
	...
	; SENDINPUT {RIGHT}
	SENDINPUT {LEFT}
	SETTIMER TIMER_SELECT_20_PHOTO_WITH_HOTKEY_H_02,140
	; Soundplay, %a_scriptDir%\Autokey -- 10-READ MOUSE CURSOR ICON\start.wav
RETURN
; -------------------------------------------------------------------
