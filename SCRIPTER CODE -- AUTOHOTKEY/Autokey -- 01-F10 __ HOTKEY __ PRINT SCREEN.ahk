...
OLD_HWND_5=0
SETTIMER TIMER_TOP_LEFT_MOUSE_REFRESH_BROWSER,100
...
TIMER_TOP_LEFT_MOUSE_CLOSE_MPC:
{
	...
	; TOOLTIP % STATE_XYPOS_COUNTER "," OLD_STATE_XYPOS_COUNTER
	...
	; TOOLTIP % STATE_XYPOS_COUNTER "`n" OLD_STATE_XYPOS_COUNTER "`n" CLASS
...
; -------------------------------------------------------------------
; -------------------------------------------------------------------
CHECK_NEW_WINDOW_TIMER_TOP_LEFT_MOUSE_REFRESH_BROWSER:
	WINGET, HWND_5, ID, A
	IF HWND_5<>%OLD_HWND_5%
	{
		SETTIMER TIMER_TOP_LEFT_MOUSE_REFRESH_BROWSER,100
	}
	OLD_HWND_5=%HWND_5%
...
TIMER_TOP_LEFT_MOUSE_REFRESH_BROWSER:
{
	...
	; STATE_XYPOS_TOP_MOUSE_REFRESH:=xpos+ypos     ; ---- USE HERE IF TOP LEFT WANT OR TOP SCREEN BELOW
	STATE_XYPOS_TOP_MOUSE_REFRESH:=ypos
	
	; TOOLTIP % STATE_XYPOS_TOP_MOUSE_REFRESH "," OLD_STATE_XYPOS_TOP_MOUSE_REFRESH
	...
	; TOOLTIP % STATE_XYPOS_COUNTER_TOP_MOUSE_REFRESH "," OLD_STATE_XYPOS_COUNTER_TOP_MOUSE_REFRESH
	...
	; TOOLTIP % STATE_XYPOS_COUNTER_TOP_MOUSE_REFRESH "`n" OLD_STATE_XYPOS_COUNTER_TOP_MOUSE_REFRESH "`n" CLASS

	; RETURN

	IF XR=0 
	{
		SETTIMER TIMER_TOP_LEFT_MOUSE_REFRESH_BROWSER,OFF
		SETTIMER CHECK_NEW_WINDOW_TIMER_TOP_LEFT_MOUSE_REFRESH_BROWSER,1000
		RETURN
	}
	
	;IF XR>0
	;IF STATE_XYPOS_TOP_MOUSE_REFRESH=0
	;IF STATE_XYPOS_COUNTER_TOP_MOUSE_REFRESH<>%OLD_STATE_XYPOS_COUNTER_TOP_MOUSE_REFRESH%
		;SOUNDBEEP 2000,100
		
	IF STATE_XYPOS_COUNTER_TOP_MOUSE_REFRESH>0
	IF STATE_XYPOS_COUNTER_TOP_MOUSE_REFRESH<>%OLD_STATE_XYPOS_COUNTER_TOP_MOUSE_REFRESH%
	{
		OLD_STATE_XYPOS_COUNTER_TOP_MOUSE_REFRESH=%STATE_XYPOS_COUNTER_TOP_MOUSE_REFRESH%
		SetTimer, STATE_XYPOS_LIMIT_TIMER_TOP_LEFT_MOUSE_REFRESH_BROWSER, 2000 ;<-- set a oneshot 1 second timer to stop the loop
	}
	OLD_STATE_XYPOS_COUNTER_TOP_MOUSE_REFRESH=%STATE_XYPOS_COUNTER_TOP_MOUSE_REFRESH%
	...
	IF (STATE_XYPOS_COUNTER_TOP_MOUSE_REFRESH>1 or A_PriorKey=27)
	{
		IF XR>0 
		{
			...
			IF XR<4
			{
				SETTIMER CHECK_NEW_WINDOW_TIMER_TOP_MOUSE_REFRESH_BROWSER_SOUNDPLAY,50
				SENDINPUT {F5}
				XR=0
				STATE_XYPOS_COUNTER_TOP_MOUSE_REFRESH=0
			}
