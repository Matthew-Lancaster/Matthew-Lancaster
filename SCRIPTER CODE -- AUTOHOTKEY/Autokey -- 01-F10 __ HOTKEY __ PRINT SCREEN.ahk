...
IF INSTR(WWWW,"CODE -- VBSCRIPT\VBS 79-GOODSYNC SCRIPT VB EXE.VBS")>0
{
	StringReplace, WWWW, WWWW,CODE -- VBSCRIPT\VBS 79-GOODSYNC SCRIPT VB EXE.VBS,CODE -- VBSCRIPT\VBS 79-GOODSYNC SCRIPT VB6__KILL TO ALLOW REMOTE COPY OVER.VBS, All
	Clipboard=%WWWW%
}	
