; Script:	C:\SCRIPTER\SCRIPTER CODE -- VB 02 VBSCRIPT\VBS 24-i_view32 convert_CCSE.VBS
; Line:	193
...
IF INSTR(WWWW,"C:\SCRIPTER\SCRIPTER CODE -- VB 02 VBSCRIPT\")>0
{
	StringReplace, WWWW, WWWW,C:\SCRIPTER\SCRIPTER CODE -- VB 02 VBSCRIPT\,C:\SCRIPTER\SCRIPTER CODE -- VB 02 VBSCRIPT\, All
	Clipboard=%WWWW%
}
...
HOT_KEY_CONVERT_TExT:
	...
	IF VAR_INDEX=4
	{
		...
		IF SUBSTR(Clipper_1_GET,A_INDEX,1)=" "
			SELECT_NOT=1
		IF SUBSTR(Clipper_1_GET,A_INDEX,1)="`n"
			SELECT_NOT=1
		IF SUBSTR(Clipper_1_GET,A_INDEX,1)="`r"
			SELECT_NOT=1
...
TIMER_CLIPBOARD_LOGGGER_KEEP_RUNNER:
	...
	SETTIMER TIMER_CLIPBOARD_LOGGGER_KEEP_RUNNER,300000
	DetectHiddenWindows, ON
	SetTitleMatchMode 2
