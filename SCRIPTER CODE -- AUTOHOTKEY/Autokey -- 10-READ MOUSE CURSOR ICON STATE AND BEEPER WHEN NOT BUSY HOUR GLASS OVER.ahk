...
if A_Cursor<>%Saved_MOUSE_CURSOR_Title_02%
{
	...
	if A_Cursor=Wait
		SETTIMER TIMER_SOUNDPLAY_REPEAT_TICKER_BUSY_HOUR_GLASS_02,500
	...
	if A_Cursor=Unknown     ; ---- IS THE "HAND" -- RIGHT MOUSE DOWN -- DRAG AND MOVER IN XNVIEW_XP
		SETTIMER TIMER_SOUNDPLAY_REPEAT_TICKER_BUSY_HOUR_GLASS_02,1000
...
FN_NAME:="C:\SCRIPTER\SCRIPTER CODE -- VB 02 VBSCRIPT\VBS 24-I_VIEW32 CONVERT_CCSE.AHK"
IF WinExist(FN_NAME) 
	ALLOW_SOUND=0
