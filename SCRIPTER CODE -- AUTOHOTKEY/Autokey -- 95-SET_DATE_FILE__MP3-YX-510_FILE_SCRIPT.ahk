...
RETREIVE_MODIFIED_DATE_SORTED_CONTECT_TO_LIST_FILE:
	...
	IF FileExist(FILE_PLAY_SCRIPT_OUT_VIDEO)
		FileDelete, %FILE_PLAY_SCRIPT_OUT_VIDEO%
	IF FileExist(FILE_PLAY_SCRIPT_OUT_MUSIC)
		FileDelete, %FILE_PLAY_SCRIPT_OUT_MUSIC%
	IF FileExist(FILE_PLAY_SCRIPT_OUT_01)
	...
	Loop, Parse, FileList, `n
	{
		...
		; IF INSTR(FILEITEM2, "\M")
			; FileAppend,%FILE_PLAY_SCRIPT_LINE%,%FILE_PLAY_SCRIPT_OUT_MUSIC%

		IF INSTR(".MP3 .WAV .MP4 .WMV .AVI .MPG .MPEG .FLV",OutExtension)
		{
		
			FileAppend,%FILE_PLAY_SCRIPT_LINE%,%FILE_PLAY_SCRIPT_OUT_01%
			IF INSTR(OutDir, "\M\")
				FileAppend,%FILE_PLAY_SCRIPT_LINE%,%FILE_PLAY_SCRIPT_OUT_MUSIC%
			IF INSTR(OutDir, "I:\V\")
				FileAppend,%FILE_PLAY_SCRIPT_LINE%,%FILE_PLAY_SCRIPT_OUT_VIDEO%
