...
AUTO_RELOAD_FACEBOOK:
	...
	SET_ARRAY_FB_HITT_CN_6[ArrayCount]:=180               ; ---- TIME TO SPEND RELOAD PAGE BEFORE ENGAGE AGAIN
	ArrayCount += 1
	...
	SET_ARRAY_FB_HITT_CN_5[ArrayCount]:="YES AUDIO"
	SET_ARRAY_FB_HITT_CN_6[ArrayCount]:=100
	ArrayCount += 1
...
TIMER_TOP_LEFT_MOUSE_REFRESH_BROWSER:
{
	...
	IF (STATE_XYPOS_COUNTER_TOP_MOUSE_REFRESH>1 or A_PriorKey=27)
	{
		IF XR>0 
		{
			...
			SETTIMER CHECK_NEW_WINDOW_TIMER_BROWSER_PAGE_LOAD_THEN_ESCAPE_MSGBOX_ABOUT_SPAM_DOS__4G,7000
			SETTIMER CHECK_NEW_WINDOW_TIMER_BROWSER_PAGE_LOAD_THEN_ESCAPE_MSGBOX_ABOUT_SPAM_DOS__1X,10000
			SENDINPUT {F5}
			STATE_XYPOS_COUNTER_TOP_MOUSE_REFRESH=0
		}	
