;  =============================================================
;# __ C:\SCRIPTER\SCRIPTER CODE -- AUTOHOTKEY\Autokey -- 19-SCRIPT_TIMER_UTIL_1.ahk
;# __ 
;# __ Autokey -- 19-SCRIPT_TIMER_UTIL_1.ahk
...
; Location Internet
;---------------------------------------------------------------------
; Matthew-Lancaster/Autokey -- 19-SCRIPT_TIMER_UTIL_1.ahk at master · Matthew-Lancaster/Matthew-Lancaster
...
TIMER_OWNER_RUN_BATCH_FILER_COUNT_DAY=0
DAY_AND_HOUR_NOW=
...
VBS_58_VB6_CORRECT_MSCOMCTL_OCX_2_2_VBS:
	...
	Element_1:="C:\SCRIPTER\SCRIPTER CODE -- VB 02 VBSCRIPT\VBS 58-VB6 CORRECT MSCOMCTL.OCX _2.2_ _TO_ _2.1_.VBS"
...
VBS_35_RENAMER_VB6_VBP_LCASE_VBS:
	...
	Element_1:="C:\SCRIPTER\SCRIPTER CODE -- VB 02 VBSCRIPT\VBS 35-RENAMER VB6 _VBP LCASE.VBS"
...
; ; GOSUB SUB_RESTORE_VB_KEEP_RUNNER_02
; ; GOSUB TIMER_SUB_VB_KEEP_RUNNER
; ; GOSUB TIMER_SUB_VB_KEEP_RUNNER_02
; ; GOSUB NOT_RESPOND_VB_KEEP_RUNNER_04
; ; OL_Day_Get__01=2
; ; GOSUB MIDNIGHT_AND_HOUR_TIMER
; GOSUB CLOSE_ALL_VB__AHK_CLASS_WNDCLASS_DESKED_GSK_MIDNIGHT
; }
; RETURN
...
MIDNIGHT_AND_HOUR_TIMER:
	...
	IF OL_Day_Get__01<>%Midnight_Get_01%
	{
		...
		{	
			...
			; ---- RUN EVERY 3 OR 4  DAY
			; --------------------------
			TIMER_OWNER_RUN_BATCH_FILER_COUNT_DAY+=1
			IF TIMER_OWNER_RUN_BATCH_FILER_COUNT_DAY>3
			{
			TIMER_OWNER_RUN_BATCH_FILER_COUNT_DAY=0
...
GITHUB_MIDNIGHT_AND_MIDDAY_TIMER:
	...
	FILE_NET_C=\\4-ASUS-GL522VW\7_ASUS_GL522VW_01_C_DRIVE\SCRIPTOR DATA\SCRIPTER CODE -- AUTOHOTKEY\Autokey -- 19-SCRIPT_TIMER_UTIL_2_TIMER_GITHUB_CLICKER_#NFS_EX__.txt
	FILE_NET_D=\\4-ASUS-GL522VW\7_ASUS_GL522VW_02_D_DRIVE\SCRIPTOR DATA\SCRIPTER CODE -- AUTOHOTKEY\Autokey -- 19-SCRIPT_TIMER_UTIL_2_TIMER_GITHUB_CLICKER_#NFS_EX__.txt
	...
	IF GOODSYNC_SET_GO=TRUE
	{
		...
		IfExist, %FN_VAR%
		{
			...
			; NOT GOODSYNC2GO
			; -------------------------------------------------------
			; APPLY TO ONLY -- A_ComputerName="4-ASUS-GL522VW"
...
FN_VAR_20:="C:\SCRIPTER\SCRIPTER CODE -- VB 02 VBSCRIPT\VBS 23-MY IP.VBS"
IfExist, %FN_VAR_20%
	{
		Run, %FN_VAR_20%
	}
...
FN_VAR_01:="C:\SCRIPTER\SCRIPTER CODE -- VB 02 VBSCRIPT\VBS 24-I_VIEW32 CONVERT_CCSE.AHK"
IfExist, %FN_VAR_01%
	{
		Run, %FN_VAR_01%
	}
