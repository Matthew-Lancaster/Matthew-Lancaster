...
Private Sub Form_Load()
    ...
    ScanPath.Caption = ScanPath.Caption + " -- " + App.Path
...
Dim LV As ListItem
    ...
    With ListView1
        ...
        If chkCopyMemory.Value Then
            ...
            UV = UV + uWIN32.nFileSizeLow
            Label13 = "Tot Size = " + Format$((UV / (1048576)), "###,000 ") + "Mb"
            If Int(UV / (1048576)) = 0 Then
            Label13 = "Tot Size = " + Format$((UV / (1024)), "###,000 ") + "Kb"
            End If
