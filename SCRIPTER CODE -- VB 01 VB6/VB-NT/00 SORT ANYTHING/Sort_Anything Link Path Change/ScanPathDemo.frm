...
'txtPath.Text = "E:\01 VB Shell Folders\Zz of 09 Office Tools\00 Shell Notepad Loader"
'Call cmdScan_Click
'txtPath.Text = "E:\01 VB Shell Folders\Zz of 09 Office Tools\00 Shell KeyBoard Loader"
'Call cmdScan_Click
'txtPath.Text = "E:\01 VB Shell Folders\Zz of 09 Office Tools\00 Shell Excel Loader"
'Call cmdScan_Click
'txtPath.Text = "E:\01 VB Shell Folders\Zz of 09 Office Tools\00 Shell Explorer Loader"
'Call cmdScan_Click
'txtPath.Text = "D:\# MY DOCS\# 01 My Documents\00 Blue Tooth Sync Folder\Links"
'Call cmdScan_Click

'txtPath.Text = "E:\01 VB Shell Folders"
'Call cmdScan_Click
txtPath.Text = "D:\# MY DOCS\# 01 My Documents\00 Blue Tooth Sync Folder"
txtPath.Text = "E:\01 VB Shell Folders\Zz of 09 Office Tools\00 Shell Vbasic 6 Loader"
txtPath.Text = "D:\VB6"
txtPath.Text = "E:\01 VB Shell Folders\Zz of 09 Office Tools\00 Shell Loader Loader"
...
For we = 1 To ListView1.ListItems.Count
    ...
    'If rt = 1 Then dd$ = "callerid"
    'If rt = 2 Then dd$ = "01 my documents"
    
    from1 = "u:\"
    to1 = "D:\"
    
    If InStr(LCase$(rr$), dd$) > 0 Then
        ww = InStr(LCase(rr$), from1)
        If ww > 0 Then Mid$(rr$, ww, 3) = to1
        ww = InStr(LCase(rr$), from1)
        If ww > 0 Then Mid$(rr$, ww, 3) = to1
        ww = InStr(LCase(rr$), from1)
        If ww > 0 Then Mid$(rr$, we, 3) = to1
        ww = InStr(LCase(rr$), Mid$(from1, 1) + Chr$(0) + ":" + Chr(0) + "\")
        If ww > 0 Then
            Mid$(rr$, ww, 5) = Mid$(to1, 1, 1) + Chr(0) + ":" + Chr(0) + "\"
        End If
    End If
