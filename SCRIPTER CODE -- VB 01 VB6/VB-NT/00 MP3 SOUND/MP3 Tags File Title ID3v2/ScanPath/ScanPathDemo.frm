...
'TWO OF THESE REMED OUT

'#### NOTE THIS REMED OUT
'    'TEMP
'    If fh = INVALID_HANDLE_VALUE Then
'        'MsgBox (fileName + vbCrLf + "File Got a INVALID_HANDLE_VALUE" + vbCrLf + "Proberbly -- File is containing Just a Header and no MP3 data no Use to Us"): Exit Function
'        Exit Function
'    End If
...
'Dim dufile As String
'dufile = "M:\04 Music ---\03 My Music Zen\05 Singles\#00-02 Chart.txt"
'Call LastModifiedToCurrent(dufile)
'TouchFileTimes dufile
    
    
Dim ra(20)
'ra(4) = ""
ra(1) = "M:\04 Music ---\04 My Music\01 Banging Tunes\"
'ra(2) = "M:\04 Music ---\04 My Music\01 Banging Tunes\"


'ra(1) = "M:\04 Music ---\04 My Music\02 Chart Songs\00 IDTag-Able\"
ra(2) = "M:\04 Music ---\04 My Music\Audio Recordings\"
ra(3) = "M:\04 Music ---\04 My Music\Radio\"
ra(4) = "M:\04 Music ---\04 My Music\Sterns - Fantazia\"
ra(5) = "M:\04 Music ---\04 My Music\02 Chart Songs\00 IDTag-Able\"
ra(6) = "M:\04 Music ---\02 My Music Zen Removed\"
ra(7) = "M:\04 Music ---\03 My Music Zen\"
ra(8) = "M:\04 Music ---\04 My Music Talking Books\"
ra(9) = "M:\04 Music ---\04 My Music\Comedy Mp3's\"
ra(10) = "M:\04 Music ---\04 My Music\"
...
'ra(9) = "M:\04 Music ---\04 My Music\02 Chart Songs\00 IDTag-Able\"
...
'ra(18) = "M:\04 Music ---\04 My Music\Comedy Mp3's\"
...
ra(1) = "F:\04 Music ---\03 My Music Zen\"
ra(1) = "F:\04 Music ---\03 My Music Zen\03 Small'S\"
ra(1) = "M:\04 Music ---\03 My Music Zen\"
ra(2) = "M:\04 Music ---\04 My Music\"
ra(3) = "M:\04 Music ---\04 My Music\Comedy Mp3'S\Bill Hick'S Mp3\"
ra(1) = "M:\04 Music ---\04 My Music\01 Banging Tunes\"
ra(1) = "M:\04 Music ---\03 My Music Zen\"
ra(1) = "M:\04 Music ---\"
ra(2) = "M:\Videos\00 Vid Films\MP3's\"
...
For we = ScanPath.ListView1.ListItems.Count To 1 Step -1
    ...
    If InStr(a1$, "05 Whole Lot") > 0 Then
        'ScanPath.ListView1.ListItems.Remove (we)
    End If
Next
...
lblCount = ScanPath.ListView1.ListItems.Count
...
For we = 1 To ScanPath.ListView1.ListItems.Count
    ...
    'If a1$ = "M:\04 Music ---\04 My Music\02 Chart Songs\00 IDTag-Able\Eddies CDs\Min Of Sound Annual 2003\CD 01\" Then Stop
...
On Local Error GoTo 0
    ...
    t1 = InStrRev(a3$, "\")
    t2 = 0
    If t1 > 1 Then t2 = InStrRev(a3$, "\", t1 - 1)
    If t2 > 1 Then t3 = InStrRev(a3$, "\", t2 - 1)
'    t4 = InStrRev(a3$, "\", t3 - 1)
    If t2 = 0 Then t2 = 1
    ...
    Else
        a3$ = Mid$(a3$, InStr(a3$, "\200"))
    End If
    If a3$ = "\" Then a3$ = Mid$(ScanPath.txtPath, 3, InStrRev(ScanPath.txtPath, "\") - 4)
...
'    End If
    ...
    If InTag.Album <> a3$ Then InTag.Album = a3$: kiss = 1
...
'    If InTag.title = "Anx2005Web" Then Stop
    ...
    ate7$ = "M:\04 Music ---\04 My Music\01 Banging Tunes\Above 128\"
 ...
 '   If ut = f.Size Then kiss = 0: kiss2 = 0
    ...
    If kiss = 1 Or kiss2 = 1 Then
        ...
        If wa = False Then 'INVALID_HANDLE_VALUE Then
            kiss = 0: kiss2 = 0
        End If
    ...
    If kiss = 1 Or kiss2 = 1 Then
        ...
        Change = Change + 1
        If UBound(ChangeList) <= Change Then ReDim Preserve ChangeList(Change + 500)
        ChangeList(Change) = a1$ + B1$
...
If Change = 0 Then
    ...
    ScanPath.List1.AddItem "No Changes......"
    ScanPath.List1.AddItem "--------------------------"
    ScanPath.List1.AddItem "Completed......."
Else
    ScanPath.List1.AddItem "Yes Changes......", 0
    ScanPath.List1.AddItem "---------------------------", 1
    ScanPath.List1.AddItem "Yes Changes......"
    ScanPath.List1.AddItem "---------------------------"
    ScanPath.List1.AddItem "Completed......."
End If
...
If IsIDE = False Or 1 = 1 Then
    ...
    Shell "D:\VB6\VB-NT\00 MP3 Sound\Sort_Anything_ScanPath_Mp3_Dummy_Id_Tag_For_Winamp_Playlist\Mp3_Dummy_Id_Tag_For_Winamp_Playlist.exe" + AW, vbNormalFocus
    End
End If
...
'Load ScanPath
ScanPath.txtPath = "M:\04 Music ---\04 My Music\"
'ScanPath.txtPath = "M:\04 Music ---\03 My Music Zen\"
'ScanPath.txtPath = "M:\My Music\Talking Books"
ScanPath.cboMask.Text = "*.mp3"
