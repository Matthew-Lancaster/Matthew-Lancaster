...
'--------------------------------------------
'SUNDAY 19 FEBRUARY 13:54
'JUST GOT CODE WORKING AGAIN
'AFTER WIN_COMPARE AND MENU SORTER
'HOW MANY CONFLICT DO YOU WANT
'--------------------------------------------
'--------------------------------------------
'IF NOT ENABLED AND THEN REQUIRE
'LEFT CLICKER TOOLBOX COMPONENTS
'AND THEN
'SELECTING
'MICROSOFT WINDOWS COMMON CONTROLS V5.0 (sP2)
'C:\Windows\SysWOW64\COMCTL32.OCX
'MY 64 BIT SYSTEM
'THE COMPONENT _CONTROLS_
'IS REQUIRE EVEN IF NOT LISTVIEW ON FORM
'--------------------------------------------
