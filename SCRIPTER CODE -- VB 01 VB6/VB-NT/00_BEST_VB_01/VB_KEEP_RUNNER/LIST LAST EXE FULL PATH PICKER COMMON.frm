...
i = i + 1: M(i) = "C:\PStart\# NOT INSTALL REQUIRED\01 www.System Internals.com\SysInternals\SysinternalsSuite\procexp.exe"
'i = i + 1: M(i) = "C:\PStart\# NOT INSTALL REQUIRED\01 www.System Internals.com\SysInternals\SysinternalsSuite\procexp.exe /T"
i = i + 1: M(i) = "C:\PStart\# NOT INSTALL REQUIRED\01 www.System Internals.com\SysInternals\SysinternalsSuite\Autoruns.exe"
i = i + 1: M(i) = "D:\VB6\VB-NT\00_Best_VB_01\TIMEZONE MINI GUI DISPLAY\TIMEZONE MINI GUI DISPLAY.exe"
i = i + 1: M(i) = "C:\Program Files\Common Files\Logishrd\Unifying\DJCUHost.exe"
i = i + 1: M(i) = "C:\Program Files\Logitech\SetPointP\SetPoint.exe"
i = i + 1: M(i) = ""
i = i + 1: M(i) = ""
i = i + 1: M(i) = ""
i = i + 1: M(i) = ""
...
Private Sub LISTVIEW1_Click()
    ...
    Dim RUN_BY_SHELL_INSTEAD
    
    ITEMGET = LISTVIEW1.ListItems(LISTVIEW1.SelectedItem.Index).SubItems(1)
    
    If 1 = 1 Or MNU_RUN_EXE.Caption = "RUN EXE __ TRUE" Then
        FN_VAR_1 = ITEMGET
        ' --------------------------------------------
        ' COMMANDLINE ARGUE NOT GO YET OR RUN BY SHELL
        ' --------------------------------------------
        ...
        If Err.Number > 0 Then RUN_BY_SHELL_INSTEAD = True
    End If
    ...
    If RUN_BY_SHELL_INSTEAD = True Then
...
Private Sub MNU_RUN_EXE_Click()
MNU_RUN_EXE.Caption = "RUN EXE __ TRUE"
End Sub
