...
Begin VB.Form frmMain 
   ...
   AutoRedraw      =   -1  'True
   BackColor       =   &H80000015&
   Caption         =   "EliteSpy+ by Andrea Batina 2001 __ ORGIN UNKNOWN MALE THINKER & Also Matthew Lancaster __ Contact ME __ BT __ 07722224555"
   ClientHeight    =   7572
   ClientLeft      =   60
   ClientTop       =   4536
   ClientWidth     =   12720
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.PictureBox Picture1 
         ...
         ScaleWidth      =   384
         TabIndex        =   120
         ToolTipText     =   "MOVE MOUSE TOP OF SCREN AND FORM WILL MINIMIZE"
         Top             =   36
         Width           =   384
      End
   ...
   Begin VB.CheckBox chkOnTop 
      Appearance      =   0  'Flat
      Caption         =   "ME _ Always On Top _ Registry Setting Form Load Remember"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   9
         Charset         =   0
   ...
   Begin VB.Label Label24 
      Caption         =   "2.. Use 20 Second Time Hoover and Then Land On/nover the window you want to spy"
      Height          =   852
      Left            =   3336
      TabIndex        =   47
      Top             =   2592
   ...
   Begin VB.Label Label13 
      Caption         =   "Select Process And Then Button And Then Confirm_er"
      Height          =   240
      Left            =   5436
      TabIndex        =   38
      Top             =   600
   ...
   Begin VB.Menu MNU_EXE_02 
      ...
      End
   End
   Begin VB.Menu MNU_EXE_03 
      Caption         =   "EXE MENU 03"
      Visible         =   0   'False
      Begin VB.Menu MNU_EXE_MENU_SCRIPT_FILL_03 
         Caption         =   "--01"
         Index           =   1
      End
      Begin VB.Menu MNU_EXE_MENU_SCRIPT_FILL_03 
   ...
   Begin VB.Menu MNU_GET_EXPLORER_CURRENT_SESSION_CLIPBOADIN 
      Caption         =   "GET_EXPLORER__CLIPBOADER_SESSION __ INFO TASKIKILL EXPLORER DOES THE SAME"
   End
   ...
   Begin VB.Menu MNU_LAUNCH_AUTORUNS 
      Caption         =   "04_ AUTORUNS"
   End
   Begin VB.Menu MNU_LAUNCH_PROCESS_EXPLORER 
      Caption         =   "05_ PROCESS EXPLORER SYMANTECH"
   End
   Begin VB.Menu MNU_EXE_TASK_MANAGER 
      Caption         =   "05_ TASK MANAGER _ SYSTEM ONE"
   End
...
Public MSGQ, IR, CODER_EXE_FILE_NAME_1, CODER_VBP_FILE_NAME_2, EXIT_TRUE
...
'---------------------------------------------------------
    ...
    INFO_NOTE_2 = " __ Version " + Str(App.Major) + "." + Str(App.Minor) + "." + Str(App.Revision)
...
Mnu_Menu_Item_Count.Caption = "Menu Item Count = " + Str(i_Menu_Count)
...
If Me.WindowState <> vbMinimized Then Cancel = True: Me.WindowState = vbMinimized: Exit Sub
...
Private Sub MNU_SCREEN_SHOT_ME_Click()
    ...
    FOLDERNAME_AUTO = App.Path + "\#_DATA\" + GetComputerName + "\"
    If Dir(FOLDERNAME_AUTO, vbDirectory) = "" Then
        On Error Resume Next
            MkDir FOLDERNAME_AUTO = App.Path + "\#_DATA\"
...
Shell "CMD /C START """" /REALTIME /MAX " + PROGRAM_PATH_BAT + " " + PROCESS_TO_KILLER_TO_GO, vbMinimizedNoFocus
...
End If
If Dir(PATH_NAME_AND_FILE) = "" Then
    MsgBox "BATAH FILE CREATED DID NOT HAPPEN" + vbCrLf + "2 ATTEMPT" + vbCrLf + "1.." + vbCrLf + PATH_NAME_AND_FILE_2 + vbCrLf + vbCrLf + "AND HERE" + vbCrLf + "2.. " + vbCrLf + PATH_NAME_AND_FILE_2
End If
...
Beep
Me.WindowState = vbMinimized
Shell "CMD /C START """" /REALTIME ""C:\SCRIPTER\SCRIPTER CODE -- TASKKILL BAT\TASKKILLER_EXPLORER.BAT"" " + PROCESS_TO_KILLER, vbMaximizedFocus
Beep
...
Dim PATH_FILE_NAME1, PATH_FILE_NAME2, VB_DATE

If Mid(App.Path, 1, 1) <> "D" Then Exit Sub

Dim PATH_FILE_NAME10, PATH_FILE_NAME11, PATH_FILE_NAME20, PATH_FILE_NAME22

PATH_FILE_NAME10 = App.Path
PATH_FILE_NAME11 = App.Path + "\" + App.EXEName + ".EXE"
PATH_FILE_NAME11 = Replace(PATH_FILE_NAME11, " - 64 BIT.EXE", ".EXE")
PATH_FILE_NAME20 = Replace(PATH_FILE_NAME11, "D:\VB6\", "D:\VB6-EXE'S\")
PATH_FILE_NAME22 = Replace(PATH_FILE_NAME10, "D:\VB6\", "D:\VB6-EXE'S\")
...
'---------------------------------------------------
If Dir(PATH_FILE_NAME20, vbDirectory) = "" Then
    On Error Resume Next
        MkDir PATH_FILE_NAME22
        FS.CopyFile PATH_FILE_NAME11, PATH_FILE_NAME20
    If Err.Number > 0 Then Exit Sub
End If

Set F = FS.GetFile(PATH_FILE_NAME11)
