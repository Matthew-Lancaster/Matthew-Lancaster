...
Begin VB.Form Form1 
   ...
   Begin VB.Menu MNU_FORMAT_TEXT 
      ...
      Begin VB.Menu mnu_Keyboard_Logger_Remove_Doubel_Char_Into_One 
         Caption         =   "Keyboard Logger -- Replace Double Char Into One"
      End
      Begin VB.Menu MNU_REFORMAT_REPLACE_SPACE_FOR_DASH 
         Caption         =   "REPLACE SPACE'S TO DASH'S"
      End
...
Dim PATH_TO_CLIPBOARD_IMAGE_LOGGER_AUTO_SCR__ As String
Dim PATH_TO_CLIPBOARD_IMAGE_LOGGER_AUTO_FORM_ As String

Dim PATH_TO_CLIPBOARD_IMAGE_INFO_IN_APP As String
Dim PATH_TO_CLIPBOARD_TEXT_INFO_APP_DAY_DATA As String
Dim PATH_TO_CLIPBOARD_APP_DATA As String
'--------------------------------------------------------------------
'--------------------------------------------------------------------
...
If FS.FileExists(EXECUTE_FILE_NAME) Then
    Set WSHShell = CreateObject("WScript.Shell")
...
FileName_er = PATH_TO_CLIPBOARD_APP_DATA + "\Hot Key Capture Text\HotKey-Shot % Pic Data Location.txt"
...
If FS.FolderExists(App.Path + "\# DATA\" + GetComputerName + "_" + GetUserName + "\Hot Key Capture Text") = False Then
...
Open PATH_TO_CLIPBOARD_APP_DATA + "\00_ClipBoard_Total--TRIM.txt" For Binary As #1
If LOF(1) > 1 * 1024 ^ 2 Then
    ...
    Kill PATH_TO_CLIPBOARD_APP_DATA + "\00_ClipBoard_Total--TRIM.txt"
    Open PATH_TO_CLIPBOARD_APP_DATA + "\00_ClipBoard_Total--TRIM.txt" For Binary As #1
        Put #1, , Pic12$
    Close #1
    ...
    A1 = PATH_TO_CLIPBOARD_APP_DATA + "\00_ClipBoard_Total--TRIM.txt"
...
'------------
FILENAME_IN_USE_CHECK = PATH_TO_CLIPBOARD_APP_DATA + "\#OutClipChunck.Txt"
...
Text1 = ""
On Error Resume Next
If Dir(PATH_TO_CLIPBOARD_APP_DATA + "\Start.txt") <> "" Then
    Open PATH_TO_CLIPBOARD_APP_DATA + "\Start.txt" For Input As #1
    Line Input #1, Star
    Close #1
End If
On Error GoTo 0
...
'PATH_TO_CLIPBOARD_TEXT_INFO_APP_DAY_DATA = App.Path + "\# DATA\" + GetComputerName + "_" + GetUserName + "\Day-Data"
    ' + "\Day-Data"
PATH_TO_CLIPBOARD_APP_DATA = App.Path + "\# DATA\" + GetComputerName + "_" + GetUserName
'PATH_TO_CLIPBOARD_APP_DATA +"\Day-Data
'PATH_TO_CLIPBOARD_APP_DATA +"\Day-Data
Mnu_Open_Logg.Caption = "Edit This Logg - " + PATH_TO_CLIPBOARD_APP_DATA + "\Day-Data\ClipBoard-" + Format$(start, "YYYY-MM-DD") + ".Txt"

'#IF ITS THE SAME DAY
CountR2$ = ""
If DateValue(Star) = DateValue(start) Then
    FR1 = FreeFile
    Open PATH_TO_CLIPBOARD_APP_DATA + "\#ClipBoard.Txt" For Binary As #FR1
    ...
    FILENAME_IN_USE_CHECK = PATH_TO_CLIPBOARD_APP_DATA + "\#Count.Txt"
    FR1 = FreeFile
...
Else
    tq = PATH_TO_CLIPBOARD_APP_DATA + "\#ClipBoard_Old.Txt"
    If Dir(tq) <> "" Then
        Kill tq
        If Dir(PATH_TO_CLIPBOARD_APP_DATA + "\#ClipBoard.Txt") <> "" Then
            Name PATH_TO_CLIPBOARD_APP_DATA + "\#ClipBoard.Txt" As PATH_TO_CLIPBOARD_APP_DATA + "\#ClipBoard_Old.Txt"
        Else
            Open PATH_TO_CLIPBOARD_APP_DATA + "\#ClipBoard.Txt" For Output As #FR1
            Close #FR1
        End If
    End If
    CountR = 0
...
FR1 = FreeFile
Open PATH_TO_CLIPBOARD_APP_DATA + "\Start.txt" For Output As #FR1
    Print #FR1, Format$(start, "DD-MM-YYYY")
Close #FR1

'After load most import recent load a backlogg for viewing
FR1 = FreeFile
Open PATH_TO_CLIPBOARD_APP_DATA + "\#ClipBoard_Old.Txt" For Binary As #FR1
    RrS$ = Input$(LOF(FR1), FR1)
Close #FR1
Err.Clear
On Error Resume Next
...
Txt_Search.Width = 800
Txt_Search.Left = Me.Width - Txt_Search.Width
Txt_Search.Height = 340 ' 336 IS MINIMUM HEIGHT 1 LINE ADD A FEW FOR NICER NUMBER
Txt_Search.BackColor = RGB(255, 255, 255)

Label3.Left = 0
Label3.Top = Label1.Top + Label1.Height
Label3.Height = 340
Label3.Width = Me.Width - Txt_Search.Left
...
'Mnu_Menu_Item_Count.Caption = "Menu Item Count = " + Str(i_Menu_Count) + " &&" + Str(i_Menu_Not_Visa_Count) + " Not Visable"
...
Private Sub MNU_COMPARE_Click()
    FILENAME_IN_USE_CHECK = PATH_TO_CLIPBOARD_APP_DATA + "\#COMPARE 1 DUPE CHECKER.Txt"
    FILENAME_IN_USE_CHECK_4 = FILENAME_IN_USE_CHECK
    DumVar = IsFileOpenDelay(FILENAME_IN_USE_CHECK)
    FILENAME_IN_USE_CHECK = FILENAME_IN_USE_CHECK_4
    ...
    FILENAME_IN_USE_CHECK = PATH_TO_CLIPBOARD_APP_DATA + "\#COMPARE 2 DUPE CHECKER.Txt"
    FILENAME_IN_USE_CHECK_4 = FILENAME_IN_USE_CHECK
    DumVar = IsFileOpenDelay(FILENAME_IN_USE_CHECK)
    FILENAME_IN_USE_CHECK = FILENAME_IN_USE_CHECK_4
...
Sub RECURSIVE_SEARCH_LAST_CLIPBOARD_ART_FOLDER()
    ...
    objStartFolder = "D:\0 00 Art Loggers\# APP AND SCREEN\" + GetComputerName
    Set fld = FSO.GetFolder(objStartFolder)
    Call RecursiveSearch_Most_Recent(fld, 0)
...
Dim fil As File
    ...
    For Each fil In fld.Files
        If InStr(fil.Name, search) Then
            If fil.DateLastModified > STORE_DATE Then RecursiveSearch_Most_Recent_VAR = fil.Path
        End If
    Next fil
...
If Menu_Height + Me.Top + Me.Left + Me.Width + Me.Height = OLTLWH_3 Then Exit Sub
OLTLWH_3 = Menu_Height + Me.Top + Me.Left + Me.Width + Me.Height
...
Label3.Width = Form1.Width - 70

Txt_Search.Width = 4000
Txt_Search.Left = Form1.Width - Txt_Search.Width
Label3.Left = 40
Label3.Width = Form1.Width - (Form1.Width - Txt_Search.Left)
...
ii = GetShortName(PATH_TO_CLIPBOARD_APP_DATA + "\")
ii = " /nologo /Dir" + ii
...
ii = Replace(ii, "Clipboard Logger", "Clipboard*Logger")
...
Me.WindowState = vbMinimized
Shell "Explorer.exe /e," + PATH_TO_CLIPBOARD_APP_DATA + """", vbNormalFocus
...
'ANSWER
vFile = PATH_TO_CLIPBOARD_APP_DATA + "\Day-Data\ClipBoard-" + Format$(start, "YYYY-MM-DD") + ".Txt"
...
vFile = PATH_TO_CLIPBOARD_APP_DATA + "\00_ClipBoard_Total--TRIM.txt"
ShellExecute Me.hWnd, "open", vFile, vbNullString, vbNullString, conSwNormal
...
'C:\Program Files\XVI32\XVI32.exe
Shell "C:\Program Files\XVI32\XVI32.exe """ + PATH_TO_CLIPBOARD_APP_DATA + "\00_ClipBoard_Total--TRIM.txt""", vbNormalFocus
...
vFile = PATH_TO_CLIPBOARD_APP_DATA + "\00_ClipBoard_Total.txt"
ShellExecute Me.hWnd, "open", vFile, vbNullString, vbNullString, conSwNormal
...
EE$ = GetShortName(PATH_TO_CLIPBOARD_APP_DATA + "\00_ClipBoard_Total.txt")
...
'    Shell "notepad " + App.Path + "\# DATA\"+GetComputerName + "\Data\00_ClipBoard_Tot_Strip.txt", vbNormalFocus
    ...
    vFile = PATH_TO_CLIPBOARD_APP_DATA + "\00_ClipBoard_Tot_Strip.txt"
    ShellExecute Me.hWnd, "open", vFile, vbNullString, vbNullString, conSwNormal
...
'If IsIDE = True Then If KeyCode = 27 Then Beep: End
...
ReDim ARRAY_ICON_NOT_WANT(File1.ListCount - 1)

For r = 0 To File1.ListCount - 1
    FR1 = FreeFile
    Open File1.Path + "\" + File1.List(r) For Binary As #FR1
        ARRAY_ICON_NOT_WANT(r) = Input(50, FR1)
    Close #FR1
Next
...
For R_LOOP_3 = 1 To 2
    ...
    For R_LOOP_2 = UBound(ARRAY_ICON_DE_DUPE_VAR_) To 0 Step -1
        ...
        If R_LOOP_1 <> R_LOOP_2 Then
            If ARRAY_ICON_DE_DUPE_VAR_(R_LOOP_1) <> "" Then
...
If Clipboard_Clear_SUPPRESS_MESSAGE = True Then
    If ClipFormatDescription = "Empty Clipboard" Then Exit Sub
End If
...
If SET_GO = False Then
    ...
    Do
        ...
        If COUNTER_ERROR > 1000 Then Exit Sub
    Loop Until Err.Number = 0
    On Error GoTo 0
...
'APPEND
'---------------------------
FILENAME_IN_USE_CHECK = PATH_TO_CLIPBOARD_APP_DATA + "\Day-Data\ClipBoard-" + Format$(start, "YYYY-MM-DD") + ".Txt"
FILENAME_IN_USE_CHECK_4 = FILENAME_IN_USE_CHECK
DumVar = IsFileOpenDelay(FILENAME_IN_USE_CHECK)
FILENAME_IN_USE_CHECK = FILENAME_IN_USE_CHECK_4
...
FILENAME_IN_USE_CHECK = PATH_TO_CLIPBOARD_APP_DATA + "\#ClipBoard.Txt"
FILENAME_IN_USE_CHECK_4 = FILENAME_IN_USE_CHECK
DumVar = IsFileOpenDelay(FILENAME_IN_USE_CHECK)
FILENAME_IN_USE_CHECK = FILENAME_IN_USE_CHECK_4
FR1 = FreeFile
...
FILENAME_IN_USE_CHECK = PATH_TO_CLIPBOARD_APP_DATA + "\00_ClipBoard_Total.txt"
FILENAME_IN_USE_CHECK_4 = FILENAME_IN_USE_CHECK
DumVar = IsFileOpenDelay(FILENAME_IN_USE_CHECK)
FILENAME_IN_USE_CHECK = FILENAME_IN_USE_CHECK_4
FR1 = FreeFile
...
FILENAME_IN_USE_CHECK = PATH_TO_CLIPBOARD_APP_DATA + "\00_ClipBoard_Total--TRIM.txt"
FILENAME_IN_USE_CHECK_4 = FILENAME_IN_USE_CHECK
DumVar = IsFileOpenDelay(FILENAME_IN_USE_CHECK)
FILENAME_IN_USE_CHECK = FILENAME_IN_USE_CHECK_4
FR1 = FreeFile
...
FILENAME_IN_USE_CHECK = PATH_TO_CLIPBOARD_APP_DATA + "\00_ClipBoard_Tot_Strip.txt"
FILENAME_IN_USE_CHECK_4 = FILENAME_IN_USE_CHECK
DumVar = IsFileOpenDelay(FILENAME_IN_USE_CHECK)
FILENAME_IN_USE_CHECK = FILENAME_IN_USE_CHECK_4
FR1 = FreeFile
...
Sub SET_FOLDER_CLIPBOARD_LOGGER()
    ...
    PATH_TO_CLIPBOARD_IMAGE_LOGGER_AUTO_SCR__ = ART2$ + FF_24
    PATH_TO_CLIPBOARD_IMAGE_LOGGER_AUTO_FORM_ = ART2$ + FF_28
    ...
    End If
    PATH_TO_CLIPBOARD_APP_DATA = App.Path + "\# DATA\" + GetComputerName + "_" + GetUserName
    PATH_CHECK = PATH_TO_CLIPBOARD_APP_DATA
    If (Not DirExist(PATH_CHECK)) Then
        Err.Clear
        MkDirNested PATH_CHECK
        If Err.Number <> 0 Then
...
FILENAME1 = PATH_TO_CLIPBOARD_APP_DATA + "\Hot Key Capture Text\COMPARE DUPE.JPG"
...
'PATH_TO_CLIPBOARD_APP_DATA = App.Path + "\# DATA\" + GetComputerName + "_" + GetUserName
'PATH_TO_CLIPBOARD_APP_DATA + "\Hot Key Capture Text\
FileInUseDelay PATH_TO_CLIPBOARD_APP_DATA + "\Hot Key Capture Text\HotKey-Shot % Pic Data.txt"
FR1 = FreeFile
Open PATH_TO_CLIPBOARD_APP_DATA + "\Hot Key Capture Text\HotKey-Shot % Pic Data.txt" For Append As #FR1
...
FileInUseDelay PATH_TO_CLIPBOARD_APP_DATA + "\Hot Key Capture Text\HotKey-Shot % Pic Data Location.txt"
FR1 = FreeFile
Open App.Path + "\# DATA\" + GetComputerName + "_" + GetUserName + "\Hot Key Capture Text\HotKey-Shot % Pic Data Location.txt" For Append As #FR1
...
PATH_TO_CLIPBOARD_AND_FILENAME = PATH_TO_CLIPBOARD_APP_DATA + "\Hot Key Capture Text\HotKey-Capture- " + TimeSet2 + "-ClipText" + ".txt"
...
On Error Resume Next
'filename=
If FS.FolderExists(App.Path + "\# DATA\" + GetComputerName + "_" + GetUserName) = False Then
    MkDir App.Path + "\# DATA"
...
If FS.FileExists(FILESPEC3) = False Then Exit Sub
...
Private Sub Timer_APP_BEGIN_TIMER_Timer()
        ...
        TT_VAR_RESULT_MNU_RUN_TIME = "RUN TIME " + PROX_D + " " + PROX_H + " " + PROX_M + " " + PROX_S
        For r = 1 To 5
...
'-----------------------------------
If frmClipTest.CALC_ADDER_ENTRY = True Then
    Call CALC_DO_THE_ADDING
    frmClipTest.CALC_ADDER_ENTRY = False
Else
    Exit Sub
End If
...
STRING_VAR = " " + TT_VAR_VERSION + " __" + TT_VAR_API_RESET + " __ " + TT_VAR_RESULT_MNU_RUN_TIME + " __ " + var_xx
If CALC_STRINGER_S <> "CALC CLIPPER = NONE" Then
    STRING_VAR = STRING_VAR + " __ CALC_CLIPPER = " + Mid(CALC_STRINGER_S, InStr(CALC_STRINGER_S, "=") + 2)
End If
...
'   Exit Sub
    ...
    If OXPOS = 5 And XPOS > 0 Then
        TEXT_MNU = "GO -- CPC 00 40 80 90 -- OPEN"
