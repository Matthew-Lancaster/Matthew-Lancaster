...
'        If InStr(Path, "History Of Nearly Everything\Bill Bryson A Short History Of Everything") > 0 Then Stop
        dFile2 = GetShortName(Path + DFilename)
        LV.SubItems(2) = dFile2
