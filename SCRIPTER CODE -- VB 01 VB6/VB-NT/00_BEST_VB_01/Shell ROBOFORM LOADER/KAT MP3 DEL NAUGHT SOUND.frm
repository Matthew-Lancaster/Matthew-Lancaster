...
For Each Control In Form1.Controls
    ...
    If Mid(I1, 1, 4) = "MNU_" Then I1 = Mid(I1, 1, 4)
...
Me.Width = XW1 + 190
Me.Height = ((YH1 + (Menu_Height2 * Screen.TwipsPerPixelY)) + 1900)
...
'TESTER
'------
'ROBO_FORM_MSGBOX_CRASH_HWND = FindWinPart("GoodSync2Go")
'--------------------------------------------------------------------------------
ROBO_FORM_MSGBOX_CRASH_HWND = FindWindow("#32770", "Preparing Crash Report - GoodSync")
i3 = ROBO_FORM_MSGBOX_CRASH_HWND
If i3 = 0 Then ROBO_FORM_MSGBOX_CRASH_HWND = FindWindow("#32770", "GoodSync Crash")
i3 = ROBO_FORM_MSGBOX_CRASH_HWND
If i3 > 0 And i3 <> OcWnd_ROBO_FORM_CRASH Then
