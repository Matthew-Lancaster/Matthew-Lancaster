...
Private Sub cmdAddContact_Click()
   ...
   'NewDisplayName = "### HardTest"
   'Me.lblResult = kWabAddNew(kw, NewDisplayName, UseUnicode)
   
   If NewDisplayName = "" Then Call EditEmail: Exit Sub
   cmdListContacts_Click
   
   With Me.lstContacts
      .ListIndex = 0 'Set Here one want
      idxEntry = .ItemData(.ListIndex)
   End With
   
    Call cmdAddProp_Click
...
Sub EditEmail()
   ...
   End With
    ...
    Call cmdAddProp_Click
     ...
     'Call cmdAddProp_Click
   Call cmdEditProp_Click

End Sub

Private Sub cmdOpenWab_Click()
   Dim r As Long
...
Private Sub cmdAddProp_Click()
   ...
   Select Case kWabGetPropType(PropTag)
      ...
      Case PT_STRING8, PT_UNICODE
         ...
         'lContacts(idxEntry).lpb '-- 34294768
