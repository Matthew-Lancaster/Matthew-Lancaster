...
ScanPath.txtPath.Text = "D:\# MY DOCS\# 01 My Documents\03 PDF Files"
ScanPath.cboMask.Text = "*.pdf"
Call ScanPath.cmdScan_Click

ScanPath.chkSubFolders.Value = vbChecked
ScanPath.txtPath.Text = "D:\# MY DOCS\# 01 My Documents\NHS"
ScanPath.cboMask.Text = "*.pdf"
Call ScanPath.cmdScan_Click

ScanPath.chkSubFolders.Value = vbChecked
ScanPath.txtPath.Text = "D:\# MY DOCS\# 01 My Documents 02"
ScanPath.cboMask.Text = "*.pdf"
Call ScanPath.cmdScan_Click
...
For r = ScanPath.ListView1.ListItems.Count To 1 Step -1
    ...
    ttg$ = a1$ + b1$
    If InStr(LCase$(a1$), LCase$("My Webs\MatthewLan.com_WebSite_Backup")) > 0 Then
            ScanPath.ListView1.ListItems.Remove (r)
    End If
    For r2 = r - 1 To 1 Step -1
        a1$ = ScanPath.ListView1.ListItems.Item(r2).SubItems(1)
        b1$ = ScanPath.ListView1.ListItems.Item(r2)
        ttg2$ = a1$ + b1$
        If ttg2$ = ttg$ Then
            ScanPath.ListView1.ListItems.Remove (r)
        End If
