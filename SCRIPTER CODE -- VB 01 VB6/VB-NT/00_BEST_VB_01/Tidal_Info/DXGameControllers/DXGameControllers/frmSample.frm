...
Begin VB.Form frmDXGAMEJOY 
   ...
   Visible         =   0   'False
   Begin VB.Timer Timer_RefreshJoyList 
      Enabled         =   0   'False
      Interval        =   1000
      Left            =   3480
      Top             =   2652
...
'        Next
    ...
    If Err.Number = 0 Then 'And ERR_FILENAME_2 = False Then
        ...
        If RefreshJoyList_DONE = False Then
            RefreshJoyList  'Update our controller display
        End If
        Exit Sub
    End If
...
'        MSGB2 = MSGB2 + "THIS INSTALL IS 64 BIT IN \Program Files" + vbCrLf + vbCrLf
    ...
    Timer_RefreshJoyList.Enabled = True
End Sub
...
Private Sub RefreshJoyList()
    Dim i As Integer
    RefreshJoyList_DONE = True
    lboLst.Clear
    JOY_CONTROLLER_F710_PORT = 0
    JOY_CONTROLLER_RumblePad_2_PORT = 0
    ...
    If JOY_CONTROLLER_F710_PORT = 0 Then
        ATidalX.ME_PLAY_TEXT_TO_SPEECH_TIMER.Enabled = False
    End If
    If JOY_CONTROLLER_RumblePad_2_PORT = 0 Then
        ATidalX.ME_PLAY_TEXT_TO_SPEECH_TIMER.Enabled = False
    End If
...
Private Sub mLst_ElementChange(ByVal index As Integer, ByVal Element As ControllerElement, ByVal Pressed As Boolean)
    ...
    ' -----------------------------------------------
    ' THIS DOESN'T HAPPEN YET IS IN THE ROUTINE ABOVE
    ' TRY KEEP IN ONE ROUTINE BUT NOT GOOD-ER
    ' THE TIMER MUST BE SEPERATED
    ' -----------------------------------------------
    If index = -10 Then
        If JOY_CONTROLLER_F710_PORT = 0 Then
            ATidalX.ME_PLAY_TEXT_TO_SPEECH_TIMER.Enabled = False
...
'    End If
    ...
    If JOY_CONTROLLER = "Logitech Cordless RumblePad 2" Then
        If ElementName_VAR = "Button 6" And Pressed = True Then
            MOTION_FAST_FORWARD_BUTTON_GO = True
        End If
        If ElementName_VAR = "Button 6" And Pressed = False Then
            MOTION_FAST_FORWARD_BUTTON_GO = False
        End If
    End If
    '--------------------------
    'REVERSE
    ...
    If JOY_CONTROLLER = "Logitech Cordless RumblePad 2" Then
        If ElementName_VAR = "Button 5" And Pressed = True Then
            MOTION_REVERSE_BUTTON_GO = True
        End If
        If ElementName_VAR = "Button 5" And Pressed = False Then
            MOTION_REVERSE_BUTTON_GO = False
        End If
    End If
    '--------------------------
    'FAST-FORWARD
    ...
    If JOY_CONTROLLER = "Logitech Cordless RumblePad 2" Then
        If ElementName_VAR = "Button 8" And Pressed = True Then
            JOY_VOLUME_UP_BUTTON_GO = True
        End If
        If ElementName_VAR = "Button 8" And Pressed = False Then
            JOY_VOLUME_UP_BUTTON_GO = False
        End If
    End If
    '--------------------------
    'VOLUME DOWN
    ...
    If JOY_CONTROLLER = "Logitech Cordless RumblePad 2" Then
        If ElementName_VAR = "Button 7" And Pressed = True Then
            JOY_VOLUME_DOWN_BUTTON_GO = True
        End If
        If ElementName_VAR = "Button 7" And Pressed = False Then
            JOY_VOLUME_DOWN_BUTTON_GO = False
        End If
    End If
    '--------------------------
    'VOLUME UP
    ...
    If JOY_CONTROLLER = "Logitech Cordless RumblePad 2" Then
        If ElementName_VAR = "Button 3" Then
            If Pressed = True Then
                If JOY_PAUSE_BUTTON_GO = False Then
                    JOY_PAUSE_BUTTON_GO = True
                    Call WinAmpCommands(2)
                End If
            End If
            If Pressed = False Then
                JOY_PAUSE_BUTTON_GO = False
            End If
        End If
    End If
...
Private Sub Timer_RefreshJoyList_Timer()
...
'    Me.Refresh
    mLst.RescanForDevices  'Rescan
    RefreshJoyList
    If mLst.Count > 1 And GetComputerName = "4-ASUS-GL522VW" Then
        Timer_RefreshJoyList.Enabled = False
    End If
End Sub
