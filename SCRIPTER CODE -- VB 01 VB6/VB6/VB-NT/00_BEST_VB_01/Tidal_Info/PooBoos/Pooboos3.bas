Attribute VB_Name = "Pooboos_1100_3"
...
Function SpecialFoldersAre()
    ...
    LP_RESULT_CALLBACK = MsgBox("My Documents folder is located at : " + GetSpecialfolder(CSIDL_PERSONAL), vbInformation, "Desktop Folder")
    End
End Function
...
Function LastModifiedToCurrent(duFile As String)
    ...
    If TouchFileTimes(lngHandle, ByVal 0&) = 0 Then
        MsgBox "Error while changing file dates. Access Denied.", vbCritical, "Modify Error"
    Else
