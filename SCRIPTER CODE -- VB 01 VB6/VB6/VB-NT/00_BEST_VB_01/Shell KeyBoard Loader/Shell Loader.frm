...
Begin VB.Form Form1 
   ...
   Begin VB.Menu Mnu_INFORapId 
      Caption         =   "Info Rapid NotePad Files"
   End
   ...
   Begin VB.Menu MNU_INFORAPID5 
      ...
      Begin VB.Menu MNU_INFO_RAP_CONTACTS 
         Caption         =   "INFO RAPID PHONE CONTACTS SEARCH"
      End
      Begin VB.Menu MNU_INFO_RAP_CLUE 
         Caption         =   "INFO RAPID CLUED UP"
      End
      Begin VB.Menu MNU_INFO_RAP_CLIPTRIM 
         Caption         =   "INFO RAPID CLIPBOARD TRIM"
      End
      Begin VB.Menu MNU_INFO_RAP_CLIPSTRIP 
         Caption         =   "INFO RAPID CLIPBOARD STRIP"
      End
      Begin VB.Menu MNU_INFO_RAP_CLIPTRIMTOTT 
         Caption         =   "INFO RAPID CLIPBOARD TOTAL"
      End
      Begin VB.Menu MNU_INFO_RAP_CLIPdatafiles 
         Caption         =   "INFO RAPID CLIPBOARD SAMLL DATA FILES"
      End
      Begin VB.Menu Mnu_Info_Rapid_Email_Pop3_3_Months_JUSTMINE 
         Caption         =   "Info Rapid Email POP3 Last 3 Months_JUST MINE"
      End
      Begin VB.Menu Mnu_Info_Rapid_Email_Pop3_2_Months 
         Caption         =   "Info Rapid Email POP3 Last 2 Months"
      End
      Begin VB.Menu Mnu_Info_Rapid_Email_Pop3_3_Months 
         Caption         =   "Info Rapid Email POP3 Last 3 Months"
      End
      Begin VB.Menu Mnu_Info_Rapid_Email 
         Caption         =   "Info Rapid Email OUTLOOK E QUICK"
      End
      Begin VB.Menu Mnu_Rapid_USENET_BORG_SZ 
         Caption         =   "Info Rapid USENET BORG SZ"
      End
      Begin VB.Menu Mnu_Rapid_NNTP_PHILO 
         Caption         =   "Info Rapid NNTP PHILO"
      End
      Begin VB.Menu Mnu_Rapid_NNTP 
         Caption         =   "Info Rapid NNTP"
      End
      Begin VB.Menu Mnu_INFORapId_SMS 
         Caption         =   "Info Rapid SMS"
      End
      Begin VB.Menu Mnu_INFORapId_SMS_Palm 
         Caption         =   "Info Rapid SMS Palm"
      End
      ...
      End
      Begin VB.Menu Mnu_MyWebWordLists 
         Caption         =   "Info Rapid Word Lists In My Web"
      End
      ...
      End
      Begin VB.Menu Mnu_Rapid_Proverbs 
         Caption         =   "PROVERBS"
      End
      Begin VB.Menu Mnu_Rapid_Lyrics 
         Caption         =   "LYRICS"
      End
      Begin VB.Menu Mnu_Rapid_NHS 
         Caption         =   "NHS"
      End
      Begin VB.Menu Mnu_Rapid_DOUBLE 
         Caption         =   "LIST COMMON WORDS DOUBLE WORD SOURCE"
      End
      Begin VB.Menu Mnu_EmailTexts 
         Caption         =   "EMAIL TEXTS HUGE BASE"
      End
   End
End
...
'DATE PAGE LIST
'PHONE HOLDER BED
'ANOTHER CHARGER NOKIA
'MINI KEYBOARD
'SETUP BLUETOOTH SEND
'VODO SIM
'SHAPE CODE
'JOB LIST CODE
'WORK LIST CODE
...
SH = Me.Height - 2000 'higer = smaller
...
Form1_Width = Label1(r - 1).Left + Label1(r - 1).Width + 120
Form1_Height = fheightx + 1200 '------ ADJUST NEEDED HERE
...
If Label1(index).BackColor = QBColor(12) And LoadFolder = False Then
    MsgBox "LINK MARKED RED FOR NOT USE"
    End
End If
...
On Local Error GoTo 0
skip:
Call FormStart.LabelClickFront(index)
...
Private Sub MNU_ADMINISTRATOR_Click()
    ...
    Beep
    MNU_ADMINISTRATOR.Caption = "IN ADMINISTRATOR"
    If GetSpecialfolder(38) = "" Then
        MNU_ADMINISTRATOR.Caption = Replace(MNU_ADMINISTRATOR.Caption, "IN ", "NOT IN ")
    End If
End Sub
'-------------------------------------------
'-------------------------------------------
...
Private Sub Mnu_EmailTexts_Click()
ii = " /nologo /DirD:\#*MY*DOCS\01*My*Documents\00*Email*Texts"
Shell "C:\Program Files\seRapid\seRapid.exe " + ii, vbNormalFocus
End
End Sub

Private Sub MNU_INFO_RAP_CLIPdatafiles_Click()
'D:\VB6\VB-NT\00_Best_VB_01\ClipBoard Logger\# DATA\MATT-555ROIDS\Day-Data

ii = " /nologo /DirD:\VB6\VB-NT\00_Best_VB_01\Fast*Clipboard\Data\MATT-555ROIDS\Day-Data"
Shell "C:\Program Files\seRapid\seRapid.exe " + ii, vbNormalFocus
End

End Sub

Private Sub MNU_INFO_RAP_CLIPSTRIP_Click()

ii = " /nologo /DirD:\VB6\VB-NT\00_Best_VB_01\Fast*Clipboard\Data\  /File00_ClipBoard_Tot_Strip.txt"
Shell "C:\Program Files\seRapid\seRapid.exe " + ii, vbNormalFocus
End
End Sub

Private Sub MNU_INFO_RAP_CLIPTRIM_Click()

ii = " /nologo /DirD:\VB6\VB-NT\00_Best_VB_01\Fast*Clipboard\Data\  /File00_ClipBoard_Total--TRIM.txt"
Shell "C:\Program Files\seRapid\seRapid.exe " + ii, vbNormalFocus
End
End Sub

Private Sub MNU_INFO_RAP_CLIPTRIMTOTT_Click()

ii = " /nologo /DirD:\VB6\VB-NT\00_Best_VB_01\Fast*Clipboard\Data\  /File00_ClipBoard_Total.txt"
Shell "C:\Program Files\seRapid\seRapid.exe " + ii, vbNormalFocus
End
End Sub

Private Sub MNU_INFO_RAP_CLUE_Click()
...
Private Sub MNU_INFO_RAP_CONTACTS_Click()

ii = " /nologo /DirD:\# MY*DOCS\00*Blue*Tooth*Exchange*Folder\00*CONTACTS\"
...
ii = " /nologo /DirD:\EMAIL_OE*RAPID*QUICK\"
'ii = " /nologo /DirW:"
...
Private Sub Mnu_Info_Rapid_Email_Pop3_2_Months_Click()

ii = " /nologo /DirM:\00*Loggers*Text\#00*EMAIL*DATA*POP3\z--EMAIL_RAPID_SEARCH_LAST_2_MONTHS\"
...
Private Sub Mnu_Info_Rapid_Email_Pop3_3_Months_JUSTMINE_Click()

ii = " /nologo /DirM:\00*Loggers*Text\#00*EMAIL*DATA*POP3\z--EMAIL_RAPID_SEARCH_LAST_3_MONTHS_JUST_MINE"
...
Private Sub Mnu_Info_Rapid_Email_Pop3_3_Months_Click()

ii = " /nologo /DirM:\00*Loggers*Text\#00*EMAIL*DATA*POP3\z--EMAIL_RAPID_SEARCH_LAST_3_MONTHS\"
...
ii = " /nologo /DirD:\#*MY*DOCS\CallerID"
'ii = " /nologo /DirW:"
...
Private Sub Mnu_INFORapId_SMS_Click()


ii = " /nologo /DirD:\#*MY*DOCS\02*My*Documents\BlueTooth*SMS's*From*CLipType\"
Shell "C:\Program Files\seRapid\seRapid.exe " + ii, vbNormalFocus
End
...
Private Sub Mnu_INFORapId_SMS_Palm_Click()

ii = " /nologo /DirD:\VB6\VB-NT\00_Best_VB_01\03*Palm\SMS*Pro*Palm\  /File00-SMS.txt"
Shell "C:\Program Files\seRapid\seRapid.exe " + ii, vbNormalFocus
End
...
Private Sub Mnu_MyWebWordLists_Click()
'

ii = " /nologo /DirD:\My*Webs\MatthewLan.Com*Web\LoveFolder\Word_Lists"
Shell "C:\Program Files\seRapid\seRapid.exe " + ii, vbNormalFocus
...
Shell "C:\WINDOZE\system32\NOTEPAD.EXE", vbNormalFocus

End
End Sub

Private Sub Mnu_Rapid_DOUBLE_Click()

ii = " /nologo /DirD:\00*Lists-Common-Words\Word*Source"
Shell "C:\Program Files\seRapid\seRapid.exe " + ii, vbNormalFocus


End Sub

Private Sub Mnu_Rapid_Lyrics_Click()

ii = " /nologo /DirD:\00*HTTrack\00*MEDIA*MUSIC*LYRICS\www.lyricsmania.com"
Shell "C:\Program Files\seRapid\seRapid.exe " + ii, vbNormalFocus
...
Private Sub Mnu_Rapid_NHS_Click()

ii = " /nologo /DirD:\00 HTTrack\00 NHS-  SZAZZ"
Shell "C:\Program Files\seRapid\seRapid.exe " + ii, vbNormalFocus
...
ii = " /nologo /DirD:\VB6\VB-NT\00_Best_VB_01\NNTP\LAST_BATCH"
Shell "C:\Program Files\seRapid\seRapid.exe " + ii, vbNormalFocus

End
End Sub

Private Sub Mnu_Rapid_NNTP_PHILO_Click()

ii = " /nologo /DirD:\VB6\VB-NT\00_Best_VB_01\NNTP\  /FileUSENET*POSTS*--*alt.philosophy.txt"
Shell "C:\Program Files\seRapid\seRapid.exe " + ii, vbNormalFocus
...
Private Sub Mnu_Rapid_Proverbs_Click()

ii = " /nologo /DirD:\00*HTTrack\00*PROVERBS"
Shell "C:\Program Files\seRapid\seRapid.exe " + ii, vbNormalFocus
End

End Sub

Private Sub Mnu_Rapid_USENET_BORG_SZ_Click()

ii = " /nologo /DirD:\Temp\alt.support.schizophrenia*BORG"
Shell "C:\Program Files\seRapid\seRapid.exe " + ii, vbNormalFocus
End
...
ii = " /nologo /DirD:\My*Webs\MatthewLan.Com*Web"
Shell "C:\Program Files\seRapid\seRapid.exe " + ii, vbNormalFocus
End
...
ii = " /nologo /DirD:\VB6\VB-NT\00_Best_VB_01\URL*Logger\  /FileURL*Logging.txt"
...
ii = " /nologo /DirM:\00*Loggers*Text\01_Drive_Lists\  /File01*Drive*List --Drive--*.TXT"
...
'not sub dir we have problem email them
ii = " /nologo /DirD:\VB6\VB-NT\01*Classes&Mods-CLS-BAS\  /File00_Scan_Merge_01*Classes&Mods-CLS-BAS.txt"
...
If InStr(LCase(B1$), ".lnk") > 0 Then
    ...
    'End If
    Call GETSHORTLINK(d1$)
    
    Form1.Label1(XXT2).BackColor = X_COLOR
    
    If (FS.FileExists(txtTargetPath) = False And FS.FolderExists(txtTargetPath) = False) Or Len(d1$) <= 3 Then
        Label1(XXT2).BackColor = Label7.BackColor
    End If
End If
Form1.Label1(XXT2).BackColor = X_COLOR
