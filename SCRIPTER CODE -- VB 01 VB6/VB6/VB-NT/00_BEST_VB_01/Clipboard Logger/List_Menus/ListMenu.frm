...
Public Sub GetMenuInfo_Not_SUB(hMenu As Long, Spaces As Integer, SubText, txt As String)
Dim num As Integer
Dim I As Integer
Dim length As Long
Dim sub_hmenu As Long
Dim sub_name As String
    ...
    For I = 0 To num - 1
        ...
        If SubText <> "Sub Menu ----" Then
            txt = txt & SubText & sub_name & vbCrLf
        End If
        
        ' Get its child menu's names.
        GetMenuInfo_Not_SUB sub_hmenu, Spaces + 4, "Sub Menu ----", txt
    Next I
