...
Public Function DirExist_With_FileName(sPath) As Boolean
    
    Dim DirExist_With_FileName_2 As Boolean
    
    sPath = Mid(sPath, 1, InStrRev(sPath, "\") - 1)
    
    DirExist_With_FileName_2 = (Dir(sPath, vbDirectory) <> "")
    DirExist_With_FileName = DirExist_With_FileName_2
    
    If Not DirExist_With_FileName_2 Then
        ' Err.Clear
        ...
        ' If Err.Number <> 0 Then
            ...
            MSGBOX2 = MSGBOX2 + sPath + "ERR.DESCRIPTION=" + Err.Description
