...
Dim FS, F, H, TS, FR1, FR2, iVal, iVal2, ReturnValue, QQ, ii, TF1, Flag2, TESTMODE
...
If App.PrevInstance = True Then End
    ...
    Set H = FS.Getfile("C:\Program Files\Microsoft Visual Studio\VB98\VB6.exe")
        
    If F.datelastmodified <> H.datelastmodified Then
        FS.COPYFILE App.Path + "\" + App.EXEName + ".EXE", "C:\Program Files\Microsoft Visual Studio\VB98\VB6.exe"
    
        If Err.Number > 0 Then MsgBox "#1 " + Err.Description: Stop
...
TS = App.Path + "\DATA\VBcounter1.txt"
FileInUseDelay (TS)
FR1 = FreeFile
...
TS = App.Path + "\DATA\VBcounter.txt"
FileInUseDelay (TS)
FR1 = FreeFile
...
TS = App.Path + "\DATA\LastVB COMMAND.txt"
FileInUseDelay (TS)
FR1 = FreeFile
Open TS For Output Lock Read Write As #FR1
    Print #FR1, Now
...
TS = App.Path + "\DATA\LastVB COMMAND Days48Hours.txt"
FileInUseDelay (TS)
FR1 = FreeFile
...
TS = App.Path + "\DATA\LastVB COMMAND DaysOUT.txt"
FileInUseDelay (TS)
FR2 = FreeFile
...
On Error Resume Next
Kill "D:\VB6\VB-NT\00_Best_VB_01\VB COMMAND2\DATA\LastVB COMMAND Days48Hours.txt"
Name "D:\VB6\VB-NT\00_Best_VB_01\VB COMMAND2\DATA\LastVB COMMAND DaysOUT.txt" As "D:\VB6\VB-NT\00_Best_VB_01\VB COMMAND2\DATA\LastVB COMMAND Days48Hours.txt"


TS = App.Path + "\DATA\LastVB COMMAND48HourCount.txt"
FileInUseDelay (TS)
FR1 = FreeFile
Open TS For Output Lock Read Write As #FR1
    Print #FR1, Lethal + 1
...
'NEW CREATE
TS = App.Path + "\DATA\VB-Command-Line--OBJECTS-48Hr-OUT.txt"
FileInUseDelay (TS)
FR2 = FreeFile

Open TS For Output Lock Read Write As #FR2
TS = App.Path + "\DATA\VB-Command-Line--OBJECTS-48Hr.txt"
FileInUseDelay (TS)
FR1 = FreeFile
Open TS For Input Lock Read Write As #FR1
    Do
...
Kill App.Path + "\DATA\VB COMMAND-Command-Line--OBJECTS-48Hr.txt"
Name App.Path + "\DATA\VB COMMAND-Command-Line--OBJECTS-48Hr-OUT.txt" As "D:\VB6\VB-NT\00_Best_VB_01\VB COMMAND2\DATA\VB COMMAND-Command-Line--OBJECTS-48Hr.txt"




TS = App.Path + "\DATA\VB-Command-Line--OBJECTS-48Hr-COUNT.txt"
FileInUseDelay (TS)
FR1 = FreeFile
Open TS For Output Lock Read Write As #FR1
    Print #FR1, Lethal + 1
...
'Command$
If Command$ <> "" Then
ReturnValue = shellAndWait("C:\Program Files\Microsoft Visual Studio\VB98\VB6.EXE " + Command$)
MsgBox ReturnValue
End If
...
TS = App.Path + "\DATA\VB-Command-Line--OBJECTS-TOTAL.txt"
FileInUseDelay (TS)
FR1 = FreeFile
Open TS For Append Lock Read Write As #FR1
    Print #FR1, Format(Now, "DDD DD-MM-YYYY HH:MM:SS") + " - " + Command$
...
TS = App.Path + "\DATA\VB-Command-Lines.txt"
FileInUseDelay (TS)
FR1 = FreeFile
Open TS For Append Lock Read Write As #FR1
    Print #FR1, Format(Now, "DDD DD-MM-YYYY HH:MM:SS") + " - " + Command$
