...
Private Sub LAB_TIMEZONE_Click()
...
Private Sub LAB_TIMEZONE_MouseDown(Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    If MOUSE_DOWN_EVENT_TIME = 0 Then
        MOUSE_DOWN_EVENT_TIME = Now + TimeSerial(0, 0, 3)
...
' XXT1 = "CPU TIME  " + Trim(LISTVIEW_ITEM_2)
XXT2 = "CPU AVER  " + Trim(LISTVIEW_ITEM_4)
XXT3 = "CPU NIPPER  " + Trim(LISTVIEW_ITEM_3)
'  XXT4 = "CPU NIPPER  " + Trim(LISTVIEW_ITEM_5)
XXT5 = "RUN TIME " + Trim(LISTVIEW_ITEM_6)
XXT = MyProc + " ---- " + XXT1 + "  --  " + XXT2 + "  --  " + XXT3 + "  --  " + XXT5
XXT = MyProc + " ---- " + XXT2 + "  --  " + XXT3 + "  --  " + XXT5
