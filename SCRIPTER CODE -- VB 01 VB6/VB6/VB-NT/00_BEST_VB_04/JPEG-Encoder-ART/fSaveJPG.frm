...
Private Sub ReSizeCords3(ADJUSTX, ADJUSTY)
...
'        Call ReSizeCords(ADJUSTX, ADJUSTY)
        ...
        Set m_Image = m_Image.Resample(OrgWidth, OrgHeight)
        '.ViewImage.Picture
        
        'Set m_Image = New cImage
        'm_Image.CopyStdPicture MyPic
        m_Jpeg.SampleHDC m_Image.hdc, OrgWidth, OrgHeight
        'm_Jpeg.SampleHDC
