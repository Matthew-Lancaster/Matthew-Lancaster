...
IP1 = IP1 + 1: ARRAY_I(IP1) = "D:\DSC\2015-Now Sony\" + X_YEAR + " CyberShot HX60V\DCIM"
IP1 = IP1 + 0: ARRAY_DESC(IP1) = X_YEAR + " CyberShot HX60V"
IP1 = IP1 + 1: ARRAY_I(IP1) = "D:\VI_ DSC ME\2010-Now SONY\" + X_YEAR + " CyberShot HX60V_#\DCIM"
IP1 = IP1 + 0: ARRAY_DESC(IP1) = "V " + X_YEAR + " CyberShot HX60V"
If GetComputerName <> "4-ASUS-GL522VW" Then
End If
IP1 = IP1 + 1: ARRAY_I(IP1) = "D:\DSC\2012-Now Nokia E72"
IP1 = IP1 + 0: ARRAY_DESC(IP1) = "NOKIA"
IP1 = IP1 + 1: ARRAY_I(IP1) = "D:\DSC\2017-Now FUJI XP90"
    ...
    If ARRAY_I(R_COUNTER) <> "" Then
        ...
        For WE = 1 To ListView1.ListItems.Count
            ...
            If IsNumeric(Replace(Mid(B1$, 1, 10), "-", "")) = False Then
                FLAG_OFF = True
            End If
            If FLAG_OFF = True Then Exit For
        Next
