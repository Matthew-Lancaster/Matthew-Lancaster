...
template<class T>
class CProxy_IApplicationEvents :
	public IConnectionPointImpl<T, &__uuidof(_IApplicationEvents)>
{
public:
	HRESULT Fire_ChangedTrack()
	{
		HRESULT hr = S_OK;
