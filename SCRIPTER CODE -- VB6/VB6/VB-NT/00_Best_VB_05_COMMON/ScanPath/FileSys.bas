...
Option Explicit
'Public FS
Public LAST_FILE_DATE_TIME As Date, LAST_FILE_DATE_PATH As String
Public LAST_FILE_DATE_PATH_HOT_KEY_SCREENSHOT As String
Public LAST_FILE_DATE_PATH_WEB_CAM As String
Public tFileCount, XdATE2
'##############################################################################################
...
Public Const CSIDL_WINDOWS_SYSTEM32 = 37
...
Public Function FindTreeLowerLevelWorkingExistPath(ByVal sPath As String) As String
    
    Dim nPos As Integer

    On Error GoTo FindFolderTreeError
    ...
    Do
        If nPos > 0 Then
            ...
            End If
            nPos = InStrRev(sPath, "\", nPos - 1)
        End If
    Loop Until FolderExists(sPath) = True
    
    FindTreeLowerLevelWorkingExistPath = sPath
