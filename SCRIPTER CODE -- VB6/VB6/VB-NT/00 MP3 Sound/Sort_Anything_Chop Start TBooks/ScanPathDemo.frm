...
'-------------Is This Folder Get on It at start      at       TBooks
...
txtPath.Text = "S:\My Music Talking Books\"
txtPath.Text = "E:\04 Music ---\03 My Music Zen\06 Talking\04 My Music Talking Books"
...
Open "S:\Alice In Wonderland\01_11_Alice In Wonderland 01_11.mp3" For Binary As #1
hh1$ = Input$(LOF(1), #1)
ttg1 = Len(hh1$)
Close #1
Open "S:\Alice In Wonderland\02_11_Alice In Wonderland 02_11.mp3" For Binary As #1
hh2$ = Input$(LOF(1), #1)
ttg2 = Len(hh2$)
Close #1
...
For we = 1 To ListView1.ListItems.Count
    ...
    'hh4$ = Mid$(hh3$, 1, Len(hh2$))
    
    x = 0
    If Mid$(b1$, 3, 1) = "_" Then x = 2
    If Mid$(b1$, 1, 3) = "01_" Then x = 1

    ttg = 0
    If x = 1 Then
    List1.AddItem "-1-" + a1$ + b1$
    ttg = ttg1
    End If
    If x = 2 Then
    List1.AddItem "-2-" + a1$ + b1$
    ttg = ttg2
    End If

    If ttg = 0 Then MsgBox "Non File"
    ...
    d1$ = "E:\Tbooks" + Mid$(a1$, InStr(5, txtPath.Text, "\"))
    rg = 11
    Do
    rg = InStr(rg + 1, d1$, "\")
    If rg > 0 Then
    ...
    If Dir$(d1$ + b1$) = "" Then 'Or 1 = 1 Then
            
        If ttg > 0 Then
            fr1 = FreeFile
            Open a1$ + b1$ For Binary As #fr1
            'hh3$ = Input$(LOF(fr1), fr1)
            'len(hh3$)
            hh4$ = Space$(LOF(fr1))
            Get fr1, ttg, hh4$
            'hh4$ = Mid$(hh3$, ttg)
