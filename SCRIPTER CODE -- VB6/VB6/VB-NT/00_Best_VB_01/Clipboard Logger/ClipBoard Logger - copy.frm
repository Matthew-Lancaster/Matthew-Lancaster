...
Begin VB.Form Form1 
   ...
   Begin VB.Menu MNU_EXE_LANUCHER 
      ...
      End
      Begin VB.Menu MNU_120 
         Caption         =   "FOLDER EXPLORER -- C:\ISO"
      End
      Begin VB.Menu MNU_119 
         Caption         =   "FOLDER EXPLORER -- C:\Make_PE3"
      End
      Begin VB.Menu MNU_118 
         Caption         =   "FOLDER EXPLORER -- C:\MINIPE"
      End
      Begin VB.Menu MNU_117 
         Caption         =   "FOLDER EXPLORER -- C:\Program Files"
      End
      Begin VB.Menu MNU_115 
         Caption         =   "FOLDER EXPLORER -- C:\Program Files (x86)"
      End
      Begin VB.Menu MNU_114 
         Caption         =   "FOLDER EXPLORER -- C:\PStart"
      End
      Begin VB.Menu MNU_134 
         Caption         =   "FOLDER EXPLORER -- C:\RF"
      End
      Begin VB.Menu MNU_1123 
         Caption         =   "FOLDER EXPLORER -- "
      End
      ...
      Begin VB.Menu MNU_111 
         Caption         =   "FOLDER EXPLORER -- "
      End
      Begin VB.Menu MNU_10 
         Caption         =   "FOLDER EXPLORER -- C:\HBCD"
      End
      Begin VB.Menu MNU_19 
         Caption         =   "FOLDER EXPLORER -- C:\DOWNLOADS"
      End
      Begin VB.Menu MNU_18 
         Caption         =   "FOLDER EXPLORER -- C:\Boot"
      End
      Begin VB.Menu MNU_17 
         Caption         =   "FOLDER EXPLORER -- C:\BAT"
      End
      Begin VB.Menu MNU_15 
         Caption         =   "VB FOLDER EXPLORER -- D:\VB6\VB-NT\00_Best_VB_05_COMMON"
      End
      Begin VB.Menu MNU_14 
         Caption         =   "VB FOLDER EXPLORER -- D:\VB6\VB-NT\00_Best_VB_04"
      End
      Begin VB.Menu MNU_13 
         Caption         =   "VB FOLDER EXPLORER -- D:\VB6\VB-NT\00_Best_VB_05_COMMON"
      End
      Begin VB.Menu MNU_2 
         Caption         =   "VB FOLDER EXPLORER -- D:\VB6\VB-NT\00 Send_To"
      End
      Begin VB.Menu MNU_EXPLORER_FOLDER_SEND_TO 
         Caption         =   "VB FOLDER EXPLORER -- D:\VB6\VB-NT\00 Send_To"
      End
      Begin VB.Menu MNU_EXPLORER_FOLDER_VB_NT 
         Caption         =   "VB FOLDER EXPLORER -- D:\VB6\VB-NT"
      End
      Begin VB.Menu MNU_EXPLORER_FOLDER_00_Best_VB_01 
         Caption         =   "VB FOLDER EXPLORER -- D:\VB6\VB-NT\00_Best_VB_01"
      End
   ...
   Begin VB.Menu Mnu_Options 
      ...
      Begin VB.Menu MNU_PLAY_SOUND_ON_LOAD 
         Caption         =   $"ClipBoard Logger.frx":094C
      End
   ...
   End
   Begin VB.Menu MNU_SHOW_IMAGE 
      Caption         =   "* /\/\ SHOW LAST IMAGE IN VIEWER/\/\ *"
   End
   Begin VB.Menu MNU_SCANPATH_COUNTER 
      Caption         =   "Image Counter Numeric Info"
   End
   ...
   Begin VB.Menu Mnu_Audio_ON 
      Caption         =   "** /\/\ Audio Is Off /\/\ ** Hiit On Here for ON ***"
   End
...
ART2$ = ART1$ + "# APP AND SCREEN\"
ART2$ = ART1$ + "# APP AND SCREEN\" + GetComputerName + "\Hot-Key-"
...
'------------
FILENAME_IN_USE_CHECK = App.Path + "\# DATA\" + GetComputerName + "\Data\#OutClipChunck.Txt"
...
If DateValue(Star) = DateValue(start) Then
    ...
    FILENAME_IN_USE_CHECK = App.Path + "\# DATA\" + GetComputerName + "\Data\#Count.Txt"
    FR1 = FreeFile
...
'    Exit Sub
    ...
    'WEB
    If XPOS = 0 Then XPOS = InStrRev(TEXT_PATH_L, "HTTP")
    If XPOS = 0 Then XPOS = InStrRev(TEXT_PATH_L, "WWW")
    If XPOS > 0 And OXPOS = 0 Then OXPOS = 4

    'CPC WEB
    If InStr(TEXT_PATH_L, "http://cpc.farnell.com/") > 0 Then XPOS = 1
    If XPOS > 0 And OXPOS = 0 Then OXPOS = 5
    ...
    'CPC WEB
    If OXPOS = 5 And XPOS > 0 And i Then Call MNU_CPC_Click
    If OXPOS = 5 And XPOS > 0 Then
        TEXT_MNU = "GO -- CPC 20 80 90 -- OPEN"
...
Private Sub MNU_COMPARE_Click()
    Beep
    FILENAME_IN_USE_CHECK = App.Path + "\# DATA\" + GetComputerName + "\Data\#COMPARE 1 DUPE CHECKER.Txt"
    DumVar = IsFileOpenDelay(FILENAME_IN_USE_CHECK)
    ...
    FILENAME_IN_USE_CHECK = App.Path + "\# DATA\" + GetComputerName + "\Data\#COMPARE 2 DUPE CHECKER.Txt"
    DumVar = IsFileOpenDelay(FILENAME_IN_USE_CHECK)
...
Beep
Shell "D:\VB6\VB-NT\00 Send_To\Send To Multi Menu\#0 Send To Multi Menu.exe", vbNormalFocus
Me.WindowState = vbMinimized
...
Shell "Explorer.exe D:\VB6\VB-NT\00 Send_To", vbNormalFocus
...
If Clipboard.GetFormat(vbCFBitmap) = True Then
    ...
    If Xx1 > 0 And yy1 > 0 And hh2 = 1 Then
        If Xx1 < 900 And yy1 < 900 Then
            ...
            SavePicture Picture1.Picture, App.Path + "\# DATA\" + GetComputerName + "\VBIcon.bmp"
            
            'OPEN IT AGAIN - TO GET DATA
            FR1 = FreeFile
            Open App.Path + "\# DATA\" + GetComputerName + "\VBIcon.bmp" For Binary As #FR1
                Pic2$ = Space$(LOF(FR1))
                Get #FR1, 1, Pic2$
                XLEN = Len(Pic2$)
            Close #1
            ...
            If Pic1$ <> Pic2$ And Mid$(Pic2$, 1, 3) = "BM6" And XLEN < 7000 Then 'And XLEN = 3126 Then
                If Dir(App.Path + "\# DATA\" + GetComputerName + "\VBIcon4.bmp") <> "" Then
                    Kill App.Path + "\# DATA\" + GetComputerName + "\VBIcon4.bmp"
                End If
                
                FR1 = FreeFile
                Open App.Path + "\# DATA\" + GetComputerName + "\VBIcon4.bmp" For Binary As #FR1
                    Pic1$ = Pic2$
                    Put #FR1, 1, Pic1$
                Close #FR1
...
'APPEND
'---------------------------
FILENAME_IN_USE_CHECK = App.Path + "\# DATA\" + GetComputerName + "\Data\Day-Data\ClipBoard-" + Format$(start, "YYYY-MM-DD") + ".Txt"
DumVar = IsFileOpenDelay(FILENAME_IN_USE_CHECK)
FR1 = FreeFile
...
FILENAME_IN_USE_CHECK = App.Path + "\# DATA\" + GetComputerName + "\Data\#ClipBoard.Txt"
DumVar = IsFileOpenDelay(FILENAME_IN_USE_CHECK)
FR1 = FreeFile
Open FILENAME_IN_USE_CHECK For Append As #FR1
    Print #FR1, RR$;
...
FILENAME_IN_USE_CHECK = App.Path + "\# DATA\" + GetComputerName + "\Data\00_ClipBoard_Total.txt"
DumVar = IsFileOpenDelay(FILENAME_IN_USE_CHECK)
FR1 = FreeFile
Open FILENAME_IN_USE_CHECK For Append As #FR1
    Print #FR1, RR$;
...
FILENAME_IN_USE_CHECK = App.Path + "\# DATA\" + GetComputerName + "\Data\00_ClipBoard_Total--TRIM.txt"
DumVar = IsFileOpenDelay(FILENAME_IN_USE_CHECK)
FR1 = FreeFile
Open FILENAME_IN_USE_CHECK For Append As #FR1
    Print #FR1, RR$;
...
FILENAME_IN_USE_CHECK = App.Path + "\# DATA\" + GetComputerName + "\Data\00_ClipBoard_Tot_Strip.txt"
DumVar = IsFileOpenDelay(FILENAME_IN_USE_CHECK)
FR1 = FreeFile
Open FILENAME_IN_USE_CHECK For Append As #FR1
    Print #FR1, GG$
...
If U1 > Screen.Width And U2 > Screen.Height Then Tag2 = 2 Else Tag2 = 0
...
'MkDir ART$
'MkDir ART$ + QQ2$
If FS.FolderExists(ART2$ + QQ2$ + FF) = False Then
    'If FS.FolderExists(ART1$) = False Then MkDir ART1$
    If FS.FolderExists(ART2$) = False Then MkDir ART2$
    If FS.FolderExists(ART2$ + QQ2$) = False Then MkDir ART2$ + QQ2$
    Err.Clear
    If FS.FolderExists(ART2$ + QQ2$ + FF$) = False Then MkDir ART2$ + QQ2$ + FF$
End If

'If Err.Number = 76 Then
If Err.Number <> 0 Then
    
    MSGBOX2 = "ERROR Clipboard Images Not Getting Saved - Can't Create Folder Not a D Drive Maybe" + vbCrLf + ART2$ + QQ2$ + FF$
    'MSGBOX2 = "VB IDE ICON CHANGED PROPERTY PROPERTIE" ', vbMsgBoxSetForeground
    FRM_MSGBOX.Timer1.Enabled = True
...
FileInUseDelay App.Path + "\# DATA\" + GetComputerName + "\VBDataNoTArchive\HotKey-Shot % Pic Data.txt"
FR1 = FreeFile
Open App.Path + "\# DATA\" + GetComputerName + "\VBDataNoTArchive\HotKey-Shot % Pic Data.txt" For Append As #FR1
    Print #FR1, Format$(Now, "DDD DD-MMM-YYYY HH:MM:SSa/p")
Close #FR1


'If Wo / (Ri + Wo) * 100 >= 1 Then
'FileInUseDelay App.Path + "\# DATA\"+GetComputerName+ "\VBDataNoTArchive\HotKey-" + qq3$ + "-Shot ArrayPic.jpg"
'SavePicture Picture3.Picture, App.Path + "\# DATA\"+GetComputerName+ "\VBDataNoTArchive\HotKey-" + qq3$ + "-Shot ArrayPic.jpg"
TimeSet2 = Format$(Now, "YYYY-MM-DD HH-MM-SS DDD")
TS1 = ART2$ + QQ2$ + FF$ + "\HotKey-Capture- " + TimeSet2 + "-" + QQ3$ + ".jpg"
'FileInUseDelay TS1
...
Call GetFormat_And_Display
    ...
    TS2 = ART2$ + QQ2$ + FF$ + "\HotKey-Capture- " + TimeSet2 + "-" + QQ3$ + "-ClipText" + ".txt"
    FileInUseDelay TS2
    FR1 = FreeFile
    Open TS2 For Output As #FR1
        Print #FR1, "---------------------"
...
'        Close #FR1
        ...
        Open TS2 For Input As #FR1
            ...
            End If
            '"---------------------"
            PICTURE_INFO_TEXT = String(40, "-") + vbCrLf + TS2 + vbCrLf + String(40, "-") + vbCrLf + PICTURE_INFO_TEXT + vbCrLf + String(40, "-")
...
Function IsFileOpenDelay(FILENAME_IN_USE_CHECK As String)
    ...
    Do
        DoEvents
        ii = IsFileAlreadyOpen(FILENAME_IN_USE_CHECK)
        If ii = True Then
            Sleep (200)
            DD_DIFF = DateDiff("S", Now, QQ)
            Form1.MNU_FILE_STUCK_IN_USE.Visible = True
            If DD_DIFF <> O_DD_DIFF Then
                Form1.MNU_FILE_STUCK_IN_USE.Caption = "IsFileOpenDelay Busy --" + Str(DD_DIFF) + " Secs - File Stuck In Use Of Limit -" + Str(QQ_LIMIT) + " -- " + FILENAME_IN_USE_CHECK
            End If
            O_DD_DIFF = DD_DIFF
        End If
    Loop Until ii = False Or QQ < Now
    ...
    If ii = True Then
        Form1.MNU_FILE_STUCK_IN_USE.Caption = "Error IsFileOpenDelay --" + Str(DD_DIFF) + " Second File Stuck In Use -- Of Limit --" + Str(QQ_LIMIT) + " -- " + FILENAME_IN_USE_CHECK
        MSGBOX2 = "ERROR IsFileOpenDelay " + vbCrLf + FILENAME_IN_USE_CHECK + vbCrLf + Str(DD_DIFF) + " Second of --" + Str(QQ_LIMIT) + " Limit"
        FRM_MSGBOX.Timer1.Enabled = True
    End If
End Function
...
If Dir(PATH_FILE_NAME2) = "" Then Exit Sub

Set F = FS.getfile(PATH_FILE_NAME1)
VB_DATE_OUR_DATE = F.datelastmodified

Set F = FS.getfile(PATH_FILE_NAME2)
VB_DATE_REMOTE = F.datelastmodified

If VB_DATE_REMOTE > VB_DATE_OUR_DATE Then
    MNU_VB_EXE_NEWER_IN_MIRROR.Visible = True
End If
...
If (XVB_DATE < VB_DATE And XVB_DATE > 0) Or SIMU_TEST = True Then
...
If Dir("D:\VB6-EXE'S\#00 RELOAD_MIRROR") = "" Then Exit Sub
    
File3.Path = "D:\VB6-EXE'S\#00 RELOAD_MIRROR"
File3.fileName = "RELOAD ME --*.TXT"
File3.Refresh

'If Dir("D:\VB6-EXE'S\#00 RELOAD_APPEND_SCRIPT\" + "## SCRIPT RELOAD APPEND.TXT") Then
'    'If File3.ListCount <= 1 Then Exit Sub
'End If

If File3.ListCount <= 0 Then Exit Sub

'---------------------------------------
'DO THE JOBS THAT OUR PROGRAM ABLE TO DO
'---------------------------------------
'AND THEN DO THE JOB OF ITSELF BY REMOTE
'---------------------------------------
    ...
    For r = 0 To File3.ListCount
        If InStr("-" + File3.List(r), "RELOAD ME -- ") > 0 Then
            ...
            Open File3.Path + "\" + File3.List(r) For Input As #FR1
                If Not EOF(FR1) Then Line Input #FR1, RELOAD_VAR_TO_DO
            Close #FR1
                            
            'IS IT OUR OWN PROJECT EXIT
            'OR
            'RUN LOOP FOR OTHER POJECT
            ...
            'IS THE PROJECT OTHER SET EXIST
            If Dir(RELOAD_VAR_TO_DO) <> "" Then
                Shell "D:\VB6\VB-NT\00_Best_VB_01\RELOAD_NETWORK_SYNC_EXE\RELOAD_Network_Sync_EXE_VB_MIRROR.exe """ + RELOAD_VAR_TO_DO + """"
            End If
