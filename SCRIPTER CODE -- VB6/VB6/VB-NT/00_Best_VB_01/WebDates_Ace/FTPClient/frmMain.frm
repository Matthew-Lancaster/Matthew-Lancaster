...
Private Sub Form_Load()
   Set mFTP = New cFTP
   txtServer.Text = GetSetting("eDIY FTP Client", "Settings", "Server", "")
   txtUser.Text = GetSetting("eDIY FTP Client", "Settings", "User", "")
   txtPassword.Text = GetSetting("eDIY FTP Client", "Settings", "Password", "")
   mFTP.SetModeActive
