...
Begin VB.Form frmMemInfo 
   ...
   Begin VB.TextBox txtMemoryUsagePsy 
      BackColor       =   &H8000000F&
      BorderStyle     =   0  'None
      BeginProperty Font 
         Name            =   "Tahoma"
   ...
   Begin VB.Frame Frame1 
      ...
      End
   End
   Begin VB.TextBox txtMemoryUsageGlo 
      BackColor       =   &H8000000F&
      BorderStyle     =   0  'None
      BeginProperty Font 
         Name            =   "Tahoma"
   ...
   Begin VB.Label Label8 
      Caption         =   "Memory Usage Psychical %:"
      Height          =   195
      Left            =   120
      TabIndex        =   19
      Top             =   465
...
Private Sub GetMemoryStatus()
    ...
    Dim TT, TTRaw, TTRaw1, MeMRaw
    MeMRaw = tMS.dwMemoryLoad
    
    frmMemInfo.txtMemoryUsageGlo.Text = MeMRaw & "%"
    
    
    TTRaw = 1 - tMS.dwAvailPhys / (tMS.dwTotalPhys)
    TTRaw1 = Val(Format((TTRaw) * 100, "0.00"))
    TT = Trim(str(TTRaw1)) + "%"
    
    frmMemInfo.txtMemoryUsagePsy.Text = TT
    'Drives.Label20 = tMS.dwMemoryLoad & "%"
    
    Drives.Label23 = TT
    
    If TTRaw1 < oTT1 Then E$ = "ä"
    If TTRaw1 > oTT1 And oTT1 > 0 Then E$ = "ã"
    If TTRaw1 = oTT1 Then E$ = Drives.Label25.Caption
    If oTT1 = 0 Then E$ = Drives.Label25.Caption
    Drives.Label25.Caption = E$

'    If MeMRaw < oTT2 Then E$ = "ä"
'    If MeMRaw > oTT2 And oTT2 > 0 Then E$ = "ã"
'    If MeMRaw = oTT2 Then E$ = Drives.Label22.Caption
'    If oTT2 = 0 Then E$ = Drives.Label22.Caption
'    Drives.Label22.Caption = E$
