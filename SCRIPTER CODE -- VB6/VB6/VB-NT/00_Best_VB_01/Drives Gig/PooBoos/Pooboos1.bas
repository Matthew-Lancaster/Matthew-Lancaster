Attribute VB_Name = "Pooboos_1100_1"
'Jamal 331 Pooboos_1100 Funcitonal LPBI Module for Forms.
Public CntFIU
Private Return_ThreadID As Long
...
Private Declare Function MessageBox Lib "user32" Alias "msgboxA" (ByVal hwnd As Long, ByVal lpText As String, ByVal lpCaption As String, ByVal wType As Long) As Long 'Parameter: form.(property) = msgbox(0,"Text","Caption",(vbcritical,vbinformation))  'MODULE 1119
...
Function QEmptyRecycleBinSize() As String
    ...
    If (RBinInfo.i64Size.lowpart And &H80000000) = &H80000000 Or RBinInfo.i64Size.highpart > 0 Then
        'msg = msgbox("Your Recycle Bin consumes over 2 GB right now!" + vbCrLf + "Do you want to empty it?", vbYesNo + vbQuestion)
        'QEmptyRecycleBinSize = "Recycle Bin Laden Is Over 2 Gig ¤"
        QEmptyRecycleBinSize = "Over 2 Gig"
    Else
        'msg = msgbox("Your Recycle Bin consumes" + str$((RBinInfo.i64Size.lowpart) / 1024) + " KB right now." + vbCrLf + "Do you want to empty it?", vbYesNo + vbQuestion)
        'QEmptyRecycleBinSize = "Recycle Bin ¤ " + Format((RBinInfo.i64Size.lowpart) / 1024, "###,###,##0.00") + "K"
        QEmptyRecycleBinSize = Format((RBinInfo.i64Size.lowpart) / 1024, "###,###,##0.0") + "K"
        
        If RBinInfo.i64Size.lowpart / 1024 >= 1000 Then
        'RBinInfo.i64Size.lowpart
        'QEmptyRecycleBinSize = "Recycle Bin ¤ " + Format((RBinInfo.i64Size.lowpart) / 1024 ^ 2, "0") + "M"
        QEmptyRecycleBinSize = Format((RBinInfo.i64Size.lowpart) / 1024 ^ 2, "###,###,##0.000") + "M"
        If RBinInfo.i64Size.lowpart = 0 Then
            'QEmptyRecycleBinSize = "Recyc Bin Laden ¤ Zero"
            QEmptyRecycleBinSize = "Zero"
        End If
        If RBinInfo.i64Size.lowpart > 1024 ^ 3 Then
            'QEmptyRecycleBinSize = "Recycle Bin ¤ " + Format((RBinInfo.i64Size.lowpart) / 1024 ^ 3, "0.0") + "G"
            QEmptyRecycleBinSize = Format((RBinInfo.i64Size.lowpart) / 1024 ^ 3, "###,###,##0.000") + "G"
        End If
...
End Function
Private Function TerminateForms()
    Dim Form As Form
...
End Function
Private Function GetActiveWindowTitle(ReturnParent As Long) As String
   Dim i As Long
   Dim j As Long
...
End Function
Private Function FileInUse(ByVal strFilePath As String) As Boolean
