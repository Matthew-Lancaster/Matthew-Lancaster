...
Begin VB.Form frmSender_Tidal 
   ...
   Begin VB.TextBox txtDestCaption 
      ...
      Left            =   510
      TabIndex        =   3
      Text            =   "String Receiver Tidal Info"
      Top             =   450
      Width           =   3645
   End
   ...
   End
End
Attribute VB_Name = "frmSender_Tidal"
...
Public Sub cmdSend_Click()
    ...
    If hWndTextBox > 0 Then
        'Window_Title_String = GetWindowTitle(hWndTextBox)
        'If Window_Title_String = "" Then
        '    Window_Title_String = GetWindowText(hWndTextBox)
        'End If
        
        'Text1.Text = Window_Title_String
    End If
