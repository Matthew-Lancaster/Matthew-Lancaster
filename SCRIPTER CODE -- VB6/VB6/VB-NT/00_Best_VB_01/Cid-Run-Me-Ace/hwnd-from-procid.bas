...
Do While lhTmp <> 0
    ...
    If lCurrentProcID = ProcID Then
        ...
        Window_Title_String = GetWindowTitle(lhTmp)
        If InStr(Window_Title_String, "Winamp Playlist Editor") Then
            sText = Space(255)
...
Do While lhTmp <> 0
    ...
    If lCurrentProcID = ProcID Then
        ...
        Window_Title_String = GetWindowTitle(lhTmp)
        If InStr(Window_Title_String, "- Winamp") Or InStr(Window_Title_String, "Winamp 5.094") Then
            sText = Space(255)
            Ret = GetClassName(lhTmp, sText, 255)
            sText = Left$(sText, Ret)
