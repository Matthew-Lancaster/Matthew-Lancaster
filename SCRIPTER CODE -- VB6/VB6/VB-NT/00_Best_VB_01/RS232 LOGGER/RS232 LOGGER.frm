...
If Err.Number = 8002 Then
    ...
    MsgBox "Port 2 RS232 - Wont OPEN -- MUST BE COMM 1": End
...
If Err.Number <> 0 Then
    'MsgBox "Port 2 RS232 - Wont OPEN UnKnown Error #" + Str(Err.Number) + " - " + Err.Description: End
End If
...
TS = App.Path + "\RS232 DOOR REED DATA\RS232 Reed Door Entry Exit - " + Format$(Now, "yyyy-mm-dd DDD") + ".txt"
...
If ONow > 0 And Timer1.Enabled = True Then
    ...
    Else
        ...
        TSX = App.Path + "\RS232 DOOR REED DATA\Last Door Lenght Time Logg.txt"
