...
Public Sub GetMemoryStatus()
    ...
    frmMain.txtPhysicalMemory.Text = Format$(tMS.dwTotalPhys / 1024, "###,###,###") & " Kb"
    frmMain.txtAPhysicalMemory.Text = Format$(tMS.dwAvailPhys / 1024, "###,###,###") & " Kb"
    frmMain.txtVirtualMemory.Text = Format$(tMS.dwTotalVirtual / 1024, "###,###,###") & " Kb"
    ...
    If GetComputerName = "7-ASUS-GL522VW" Then
        ...
        'txtMemoryUsage_HERE
    Else
        frmMain.Label4.Caption = "Total Physical Memory My Computer " + GetComputerName
        frmMain.txtMemoryUsage.Caption = " " & tMS.dwMemoryLoad & " %"
    End If
