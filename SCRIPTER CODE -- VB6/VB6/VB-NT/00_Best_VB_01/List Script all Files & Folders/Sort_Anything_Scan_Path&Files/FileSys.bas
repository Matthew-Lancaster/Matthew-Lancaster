...
Public MNU_IRFAR_MODE_SET
Public FILECOMPLEX
Public mDIRCount2 As Long
Public mFILECount2 As Long
Public mDIRCount3 As Long
Public mFILECount3 As Long
Public COUNTPROCES2, COUNTPROCES3, COUNTPROCES4, COUNTPROCES5, COUNTPROCES8, COUNTPROCES9

Public MDIR2
Public MDIR3
Public FS, FF01, FF02, FF03, FF04
