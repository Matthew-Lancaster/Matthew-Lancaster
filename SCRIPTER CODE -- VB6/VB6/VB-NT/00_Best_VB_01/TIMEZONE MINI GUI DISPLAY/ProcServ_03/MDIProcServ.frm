...
'    FORM_1.EXIT_TRUE = True
'    If FORM_1.EXIT_TRUE = True Then
...
'        Set Item_2 = Form_1.ListView_CPU_INFO.ListItems.Add(, , "Manufacturer & Model")
'        Item_2.SubItems(1) = Object.Manufacturer + " _ " + Object.Model
'        Set Item_2 = Form_1.ListView_CPU_INFO.ListItems.Add(, , "TotalPhysicalMemory")
...
'        End With
    ...
    Dim XI_STRING, DAY_CODE, DAY_CODE_SHUTDOWN
    ...
    'Form1.Text_SYSTEM_START_TIME_02 = XI_STRING 'Str(DateDiff("h", TT_1VDT, Now)) + " HOUR"
...
'        Set Item_2 = FORM_1.ListView_CPU_INFO.ListItems.Add(, , "Name")
'        Item_2.SubItems(1) = Trim(Object.Name)
'        Set Item_2 = FORM_1.ListView_CPU_INFO.ListItems.Add(, , "Description")
'        Item_2.SubItems(1) = Object.Description
'        Set Item_2 = FORM_1.ListView_CPU_INFO.ListItems.Add(, , "Manufacturer & Model")
'        Item_2.SubItems(1) = Manufacturer_and_Model
'
'        Set Item_2 = FORM_1.ListView_CPU_INFO.ListItems.Add(, , "Manufacturer")
'        Item_2.SubItems(1) = Object.Manufacturer
        ...
        'Set Item_2 = FORM_1.ListView_CPU_INFO.ListItems.Add(, , "AddressWidth & L2CacheSize")
        Item_2.SubItems(1) = Trim(Str(Object.AddressWidth)) + " Bit ____ " + Trim(Str(Object.L2CacheSize)) + " Kbyte"
        
        
'        Set Item_2 = Form_1.ListView_CPU_INFO.ListItems.Add(, , "L2CacheSize")
...
'        Set Item_2 = Form_1.ListView_CPU_INFO.ListItems.Add(, , "Level")
'        Item_2.SubItems(1) = Object.Level
        
        'Set Item_2 = FORM_1.ListView_CPU_INFO.ListItems.Add(, , "SocketDesignation")
...
'        Set Item_2 = Form_1.ListView_CPU_INFO.ListItems.Add(, , "ProcessorID")
