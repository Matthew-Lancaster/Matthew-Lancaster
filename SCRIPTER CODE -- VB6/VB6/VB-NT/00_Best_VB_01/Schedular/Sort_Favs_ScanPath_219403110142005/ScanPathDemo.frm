...
errs2 = 0
On Local Error GoTo jeep
FS.deletefolder "D:\# MY DOCS\# 01 My Documents\Favorites\# Matts\*"
'FS.DeleteFile b1$ + a1$
On Local Error GoTo 0
If errs2 <> 0 Then
...
FS.copyfolder "R:\Temp\Favs\*", "D:\# MY DOCS\# 01 My Documents\Favorites\# Matts\"
 
List1.AddItem "Stage 4 of 4 : Delete Temp Folder"
List1.ListIndex = List1.ListCount - 1
List1.Refresh

FS.deletefolder "R:\Temp\Favs\*"
...
Private Sub SP_FileMatch(FileName As String, Path As String)
    ...
    With ListView1
        ...
        If (LV.Index Mod 10) = 0 Then
            ...
            'Form1.Label8.Caption = lblCount.Caption
            'Form1.Label1.Caption = lblCount.Caption + TotalAll
