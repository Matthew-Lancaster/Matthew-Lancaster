...
Public Sub Command1_Click()
    ...
    'DO THIS TO FIND
    'D:\VB6\VB-NT\00_Best_VB_01\Tidal_Info\Dskbhook.dll
    'WHEN IN IDE MIGHT NOT BE APP.PATH
...
If MAIN_FORM_READY_YET = False Then Exit Sub
...
'D:\VB6\VB-NT\00_Best_VB_01\Tidal_Info\
'USE Regsvr32 Dskbhook.dll
'Shell "Regsvr32 " + App.Path + "\Dskbhook.dll"
ChDrive App.Path
ChDir App.Path
