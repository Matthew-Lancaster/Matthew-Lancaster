...
Begin VB.Form WMI_CPU 
   ...
   BackColor       =   &H80000004&
   BorderStyle     =   0  'None
   Caption         =   "REBOOT CLOSE PROGRAMS"
   ClientHeight    =   5190
   ClientLeft      =   2400
   ClientTop       =   2175
   ClientWidth     =   6975
   Icon            =   "WMICPU1.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5190
...
i = 0
i = i + 1: V(i) = "URL Logger"
i = i + 1: V(i) = "CID Run Me."
i = i + 1: V(i) = "Tidal Information..."
i = i + 1: V(i) = "Active Idle..."

i = i + 1: V(i) = "ClipBoard Logger"
i = i + 1: V(i) = "MP3 PLAYED"
i = i + 1: V(i) = "00_Schedule_Timer"
i = i + 1: V(i) = "METRONOME"
i = i + 1: V(i) = "TIMER CODE"
i = i + 1: V(i) = "CLOCK"
i = i + 1: V(i) = "KAT RECORDER TO USB PEN DRIVE AND HDD DUAL RECORDER"
i = i + 1: V(i) = "SUSPEND PROGRAM"
i = i + 1: V(i) = "Winamp v1.x"
i = i + 1: V(i) = "MozillaWindowClass"
i = i + 1: V(i) = "IEFrame"
i = i + 1: V(i) = "Google Earth"
i = i + 1: V(i) = ""
i = i + 1: V(i) = ""
i = i + 1: V(i) = ""
i = i + 1: V(i) = ""
...
For R = 1 To VLONG
    If V(R) <> "" Then
        Call CloseProgramParent("", V(R))
        DoEvents
        XH = 0
        Do While CLOSEPROG = True
            Sleep 500
            XH = XH + 1
            If XH > 8 Then Exit Do
        Loop
    End If
...
i = i + 1: V(i) = "C:\Program Files\ViceVersa Pro 2\ViceVersa.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\Tidal_Info\Tidal.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\Active Idle\Active Idle.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\URL Logger\URL Logger.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_04\RS232 LOGGER\RS232 LOGGER.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\Cid-Run-Me-Ace\Cid-RunMe.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\Set NetWork Drives\Set-NetWork-Drives.exe"
i = i + 1: V(i) = cProcesses.GetEXEID(PRC, "C:\PROGRAM FILES\PROCESSEXPLORER\PROCEXP.EXE")
i = i + 1: V(i) = sWindowsFolder + "\SYSTEM32\TASKMGR.EXE"
i = i + 1: V(i) = "C:\Program Files\KatMouse\KatMouse.exe"
i = i + 1: V(i) = "C:\Program Files\Kat MP3 Recorder\Kat MP3 Recorder.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\KAT USB PEN DRIVE RECORD\KAT_TIMER DUAL COPY.exe"
i = i + 1: V(i) = "C:\Program Files\SuperCopier2\SuperCopier2.exe"
i = i + 1: V(i) = "C:\Program Files\Olympus\DeviceDetector\DevDtct2.exe"
i = i + 1: V(i) = "C:\Program Files\WordWeb\wweb32.exe"
i = i + 1: V(i) = "C:\Program Files\Cyberdyne Systems\iCEBar.v3\iCEBar.Net.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\Wmi_CPU\WMICPU2 MINI.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\Wmi_CPU\WMICPU1 BIG.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\WinAmp MP3% MINI #\WinAmp MP3% MINI.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\WinAmp MP3%\WinAmp MP3%-VideoBar.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\ClipBoard Logger\ClipBoard Logger.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\VU_METER_LOGGER\VU METER LOGGER.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\#00_Schedule_Timer\#00_Schedule_Timer-ACER.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\#00_Schedule_Timer\#00_Schedule_Timer-ASUS.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\Drive_Detach\Drive_Detach.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_04\RS232 LOGGER\RS232 LOGGER.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\Drives Gig\Drives_Gig.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\VPN_AutoDial IP\VPN_Auto_Grab_IP.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\WinAmp MP3%\WinAmp MP3%.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\VPN_AutoDial IP\VPN_Auto-Dialer IP.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\Weather\BBCWeather.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\WinAmp MP3% MINI #\WinAmp MP3% MINI.EXE"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\WinAmp MP3%\WinAmp MP3%.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\Drive_Detach\Drive_Detach.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\VPN_AutoDial IP\VPN_Auto-Dialer IP.exe"
...
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_04\RS232 LOGGER\RS232 LOGGER.exe"
'i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\URL Logger\URL Logger.exe"
i = i + 1: V(i) = "C:\Program Files\Norton Internet Security\Engine\18.5.0.125\ccSvcHst.exe"

i = i + 1: V(i) = "C:\Program Files\Olympus\DeviceDetector\DevDtct2.exe"
i = i + 1: V(i) = "C:\Program Files\WIDCOMM\Bluetooth Software\BTTray.exe"
i = i + 1: V(i) = "C:\Program Files\Norton Utilities 14\nu.exe"
i = i + 1: V(i) = "C:\Program Files\Google\Google Earth\client\googleearth.exe"
'i = i + 1: V(i) = "C:\Program Files\Microsoft Visual Studio\VB98\VB6.EXE"
i = i + 1: V(i) = "C:\Program Files\Xmarks\IE Extension\xmarkssync.exe"
i = i + 1: V(i) = "C:\Program Files\ASUS\Wireless Console 3\wcourier.exe"
i = i + 1: V(i) = "C:\WINDOWS\system32\igfxpers.exe"
i = i + 1: V(i) = "C:\Program Files\Google\GoogleToolbarNotifier\GoogleToolbarNotifier.exe"
i = i + 1: V(i) = "C:\WINDOWS\system32\wbem\unsecapp.exe"
i = i + 1: V(i) = "C:\WINDOWS\system32\igfxtray.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\SUSPEND_PROGRAM\SUSPEND_PROGRAM.exe"
i = i + 1: V(i) = "C:\Program Files\WordWeb\wweb32.exe"
'i = i + 1: V(i) = "C:\Program Files\WIDCOMM\Bluetooth Software\bin\btwdins.exe"
i = i + 1: V(i) = "C:\WINDOWS\Explorer.EXE"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\Shell Winamp Loader\Winamp Loader.exe"
i = i + 1: V(i) = "C:\Program Files\ASUS\Net4Switch\Net4Switch.exe"
i = i + 1: V(i) = "C:\Program Files\ASUS\ASUS Live Update\ALU.exe"
i = i + 1: V(i) = "C:\WINDOWS\system32\ctfmon.exe"

'
i = i + 1: V(i) = "C:\Program Files\Google\Update\1.2.183.39\GoogleCrashHandler.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\00 Games\Breakout\BreakOut.exe"
i = i + 1: V(i) = "RAPPORTSERVICE"
i = i + 1: V(i) = "C:\Program Files\# NO INSTALL REQUIRED\01 www.System Internals.com\ProcessExplorer\procexp.exe"
i = i + 1: V(i) = "C:\Program Files\Mozilla Firefox\firefox.exe"
i = i + 1: V(i) = "C:\Program Files\Trusteer\Rapport\bin\RapportService.exe"
i = i + 1: V(i) = "C:\Program Files\Microsoft Visual Studio\VB98\VB6.EXE"
i = i + 1: V(i) = "C:\Program Files\Internet Explorer\IEXPLORE.EXE"
i = i + 1: V(i) = "C:\WINDOWS\system32\rundll32.exe"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_04\Webcam_Motion\WebCamMatts.exe"
i = i + 1: V(i) = "C:\WINDOWS\system32\taskmgr.exe"
i = i + 1: V(i) = "C:\Program Files\Google\Update\GoogleUpdate.exe"
i = i + 1: V(i) = "C:\Program Files\Windows Live\Toolbar\wltuser.exe"
i = i + 1: V(i) = "C:\Program Files\Motorola\Bluetooth\btplayerctrl.exe"
i = i + 1: V(i) = "C:\Program Files\WordWeb\wweb32.exe"
i = i + 1: V(i) = "C:\Program Files\KatMouse\KatMouse.exe"
'i = i + 1: V(i) = "C:\Program Files\TrueCrypt\TrueCrypt.exe"
i = i + 1: V(i) = "C:\Program Files\ProcessTamer\ProcessTamerTray.exe"
i = i + 1: V(i) = "C:\Program Files\Logitech\SetPointP\SetPoint.exe"
i = i + 1: V(i) = "C:\WINDOWS\system32\igfxpers.exe"
i = i + 1: V(i) = "C:\Program Files\WIDCOMM\Bluetooth Software\BTTray.exe"
i = i + 1: V(i) = "C:\WINDOWS\system32\rundll32.exe"
'i = i + 1: V(i) = "C:\Program Files\Kat MP3 Recorder\Kat MP3 Recorder.exe"
i = i + 1: V(i) = "C:\Program Files\Olympus\DSSPlayer2002\DirectrecConfig.exe"
i = i + 1: V(i) = "C:\Program Files\Google\GoogleToolbarNotifier\GoogleToolbarNotifier.exe"
i = i + 1: V(i) = "C:\Program Files\Olympus\DeviceDetector\DevDtct2.exe"
i = i + 1: V(i) = "C:\WINDOWS\system32\rundll32.exe"
i = i + 1: V(i) = "C:\Program Files\Siber Systems\AI RoboForm\RoboTaskBarIcon.exe"
i = i + 1: V(i) = "C:\Program Files\ASUS\Wireless Console 3\wcourier.exe"
i = i + 1: V(i) = "C:\WINDOWS\system32\ctfmon.exe"
i = i + 1: V(i) = "C:\WINDOWS\Explorer.EXE"
i = i + 1: V(i) = "C:\Program Files\Common Files\LogiShrd\KHAL3\KHALMNPR.EXE"
i = i + 1: V(i) = "D:\VB6\VB-NT\00_Best_VB_01\TIMER CODE\TIMER CODE.exe"
i = i + 1: V(i) = "C:\PROGRA~1\Ahead\NEROTO~1\DRIVES~1.EXE"
i = i + 1: V(i) = "C:\Program Files\Windows Live\Contacts\wlcomm.exe"
i = i + 1: V(i) = "C:\Program Files\Norton Utilities 14\nu.exe"
i = i + 1: V(i) = "C:\Program Files\Trusteer\Rapport\bin\RapportMgmtService.exe"
i = i + 1: V(i) = "C:\Program Files\Java\jre6\bin\jqs.exe"
i = i + 1: V(i) = "C:\Program Files\Windows Live\Messenger\msnmsgr.exe"
i = i + 1: V(i) = "C:\WINDOWS\system32\hkcmd.exe"
i = i + 1: V(i) = "C:\Program Files\Microsoft\Search Enhancement Pack\SeaPort\SeaPort.exe"
i = i + 1: V(i) = "C:\WINDOWS\system32\lsass.exe"
i = i + 1: V(i) = "C:\Program Files\Motorola\Bluetooth\devmgrsrv.exe"
...
For R = 1 To 5
    If V(R) <> "" Then
        PRC = -1
        EXEs = V(R)
        Call KILL_HWND_AND_PROCESS_Parent("", EXEs)
        DoEvents
    End If
Next
...
RXS = MsgBox("WANT REBOOT WITH CLOSE PROGRAMS ", vbMsgBoxSetForeground + vbYesNoCancel)
Call REBOOT
...
Sub KILL_HWND_AND_PROCESS_Parent(ByVal Caption1 As String, ByVal Caption2 As String)

Dim i As Long, PRC As Long
...
If i = 0 Then i = FindWindow(Caption2, Caption1)

If Caption2 = "" Then Caption2 = Caption1
...
Do While i <> 0
    ...
    If Mid(EXEs, 2, 1) <> ":" Then
        CurProcHwnd = i
        TF = cProcesses.Convert(CurProcHwnd, PRC, cnFromhWnd Or cnToProcessID)
    Else
        Rf2 = cProcesses.GetEXEID(PRC, EXEs)
    End If
