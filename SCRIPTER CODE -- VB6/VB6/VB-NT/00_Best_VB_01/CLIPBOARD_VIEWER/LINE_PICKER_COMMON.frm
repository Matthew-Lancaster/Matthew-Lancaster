...
Sub Form_Load()
    ...
    i = i + 1: M(i) = "----------"
    i = i + 1: M(i) = "----------"
    i = i + 1: M(i) = "nowait: ""C:\SCRIPTER\SCRIPTER CODE -- VBSCRIPT\VBS 35-RENAMER VB6 _VBP LCASE.VBS"" %JOBNAME%"""
    i = i + 1: M(i) = """C:\SCRIPTER\SCRIPTER CODE -- VBSCRIPT\VBS 24-I_VIEW32 CONVERT_CCSE.AHK"""
    i = i + 1: M(i) = """C:\SCRIPTER\SCRIPTER CODE -- VBSCRIPT\VBS 35-RENAMER VB6 _VBP LCASE.VBS"" MUTE"
    i = i + 1: M(i) = "----------"
