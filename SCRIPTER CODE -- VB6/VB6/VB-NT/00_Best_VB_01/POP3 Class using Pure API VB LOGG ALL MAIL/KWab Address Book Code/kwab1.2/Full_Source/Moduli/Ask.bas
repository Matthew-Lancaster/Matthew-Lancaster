...
Public Function AskPropTag(ByRef PropTag As Long, Optional ByVal inDefault As Long = 0) As Boolean
   ...
   'f.Show vbModal
    ...
    'frmAskPropTag.Show
    frmAskPropTag.lstTypes.ListIndex = 10
   
'   frmAskPropTag.lstPropTags.ListIndex = 11
 
    Call frmAskPropTag.lstPropTags_Click
   ...
   Unload f
    ...
    PropTag = Val(Mid$(frmAskPropTag.lblPropTag.Caption, 8))
End Function
