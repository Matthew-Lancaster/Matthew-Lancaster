...
Begin VB.Form PerCentDrive 
   ...
   End
End
Attribute VB_Name = "PerCentDrive"
...
Public LBINX As Integer, LBINXold, FirstRun, ASD
...
Check1.Top = x
Check1.Left = (Me.Width / 2) + 10
Check1.Width = Me.Width / 2
...
Me.Width = Label1(r - 1).Left + Label1(r - 1).Width + 120
Me.Height = fheightx + 700
Lbl2.Width = Me.Width
TitleLbl.Top = tg
TitleLbl.Left = 0
Combo1.Top = tg
Combo1.Left = (Me.Width / 2) + 15

TitleLbl.Width = Me.Width / 2
Combo1.Width = (Me.Width / 2) - 150
...
If LBINX < 1 Then LBINX = 1
If LBINX > ScanPath.ListView1.ListItems.Count Then LBINX = ScanPath.ListView1.ListItems.Count
