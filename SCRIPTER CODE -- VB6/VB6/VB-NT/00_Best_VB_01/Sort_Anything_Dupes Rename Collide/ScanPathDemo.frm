...
'txtPath = "D:\VB6 Icons\Icons\BlueSky Geo Gorts2"
'txtPath = "D:\VB6 Icons\Icons\Blue"
txtPath.Text = "M:\#\#D\00 Pen Drives MOBILES\DCIM\101MSDCF\104MSDCF"

If txtPath = "" Then MsgBox "TEXT PATH MUST EQUAL SOMETHING": End
...
For we = 2 To ListView1.ListItems.Count
    ...
    'If InStr(b1$, "--00") > 0 Then
    '        Name a1$ + b1$ As a1$ + Mid$(b1$, 1, InStr(b1$, "--00") - 1) + ".ico"
    'End If
    'b1$ = "xxx"
    ...
    If b1$ = b12$ Then
        ...
        c1$ = Mid$(b1$, 1, Len(b1$) - 4)
        c2$ = Mid$(b1$, Len(b1$) - 3)
        If InStr(c1$, "--00") > 0 Then c1$ = Mid$(c1$, 1, InStr(c1$, "--00") - 1)
        
        Do
        c3$ = c1$ + "--" + Format$(iu, "000") + c2$
        xxv = InStr(dupe$, c3$)
        If xxv > 0 Then
            iu = iu + 1
        End If
        ...
        Err.Clear
        Name a1$ + b1$ As a1$ + c3$
        'ListView1.ListItems.Item(we).Text = c3$
        dupe$ = dupe$ + c3$
        If Err.Number > 0 Then
            Do
            iu = iu + 1
            Err.Clear
                Name a13$ + b1$ As a1$ + c1$ + "--" + Format$(iu, "000") + c2$
            Loop Until iu > 20 Or Err.Number = 0
        End If
        If Err.Number > 0 Then
            MsgBox "Cant ReName" + vbCrLf + g3$ + b1$
        End If
...
MsgBox "End" + vbCrLf + "Renamed =" + Str(aga)
