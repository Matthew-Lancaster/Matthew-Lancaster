...
txtPath.Text = "D:\MY WEBS\MatthewLan.Com Web\LoveFolder\Cool"
cboMask = "*.html;*.html"
chkSubFolders = vbChecked
Call cmdScan_Click
txtPath.Text = "D:\MY WEBS\MatthewLan.Com Web\LoveFolder\HTML"
cboMask = "*.html;*.html"
chkSubFolders = vbChecked
Call cmdScan_Click
txtPath.Text = "D:\MY WEBS\MatthewLan.Com Web\LoveFolder\Text's"
cboMask = "*.html;*.html"
chkSubFolders = vbChecked
Call cmdScan_Click
...
For we = 1 To ListView1.ListItems.Count
    ...
    xc = 0
    If InStr(b1$, "All in One --") > 0 Then we = we + 1: xc = 1 ': Stop
    If InStr(b1$, "SiteMainMap.html") > 0 Then we = we + 1: xc = 1 ': Stop
    If InStr(b1$, "LinkPage") > 0 Then we = we + 1: xc = 1 ': Stop
...
Open txtPath.Text + "All in One -- Matthewlan-Com.txt" For Output As #1
