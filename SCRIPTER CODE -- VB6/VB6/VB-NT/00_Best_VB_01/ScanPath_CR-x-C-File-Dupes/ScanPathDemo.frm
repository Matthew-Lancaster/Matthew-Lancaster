...
'-------------Is This Folder Get on It at start      at       AutoPix
...
tp1$ = "S:\00 Art\AutoPix Dont Want CRC - Done\"

txtPath.Text = "S:\00 Art\AutoPix Dont Want CRC\"
...
f1 = FreeFile
Open txtPath.Text + "CRC File.txt" For Append As #f1
Call cmdScan_Click
...
f1 = FreeFile
Open "S:\00 Art\AutoPix Dont Want CRC\CRC File.txt" For Input As #f1
rr$ = Input$(LOF(f1), f1)
Close #f1

For r3 = 1 To 1

If r3 = 2 Then txtPath.Text = "S:\Art\AutoPix\AutoPix 000-000\"


If r3 = 1 Then txtPath.Text = "S:\Art\AutoPix\AutoPix zz 000-000\"
If r3 = 1 Then txtPath.Text = "S:\Art\AutoPix\AutoPix (Main)\AutoPix 2007 05 04 Month K Files\"

If r3 = 1 Then txtPath.Text = "S:\Art\AutoPix\AutoPix (Main)\AutoPix 2007 05 27K Files\"
If r3 = 1 Then txtPath.Text = "S:\Art\AutoPix\AutoPix (Main)\"

If r3 = 1 Then txtPath.Text = "S:\00 Art\AutoPix\AutoPix001\"

If r3 = 1 Then txtPath.Text = "S:\00 Art\AutoPix\"
If r3 = 1 Then txtPath.Text = "S:\Art\AutoPix\AutoPix (Main)\AutoPix 2007 05 25K Files\"

If r3 = 1 Then txtPath.Text = "S:\00 Art\AutoPix\AutoPix (Main)\"
...
Label14.Caption = "Wait till End Sort"
...
rt = 0
If InStr(rr$, g1$) And Trim(g1$) <> "" And Trim(h1$) <> "" Then
    If rt = 0 Then MsgBox "1st Del CRC Dont Want"
    rt = 1
    If Hax = 0 Then MsgBox "Start Kill CRC Dont Want": Hax = 1
    Kill g3$ + b1$
    aga = aga + 1
    Label14.Caption = Str(aga)
End If
...
'Shell "C:\Program Files\IceView\IceView.exe " + g3$ + b1$, vbNormalFocus
    ...
    If g1$ = h1$ And Trim(g1$) <> "" And Trim(h1$) <> "" Then
        aga = aga + 1
        Label14.Caption = Str(aga)
        
        'Del the latest in list
        If g2 > h2 Then xxcrc = 1
        If g2 < h2 Then xxcrc = 2
        
        
        If xxcrc = 1 Then
            If Hax2 = 0 Then MsgBox "Start Kills ---": Hax2 = 1
            Kill g3$ + b1$
        End If
        If xxcrc = 2 Then
            If Hax2 = 0 Then MsgBox "Start Kills ---": Hax2 = 1
