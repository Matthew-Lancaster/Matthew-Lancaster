...
Begin VB.Form frmCapVid 
   ...
   Begin VB.CommandButton Command1 
      BackColor       =   &H0000C0C0&
      Caption         =   "Com&press... -- Must Set This One -- 90% Better File Size With Some Compression"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
...
Select Case Index
    Case 0 'OK
        Call ProcessCapInfo
        If Mnu_Capture_Video_Seqence_Click_True = True Then Unload Me
        'If QuickCapture = True
        Unload Me
