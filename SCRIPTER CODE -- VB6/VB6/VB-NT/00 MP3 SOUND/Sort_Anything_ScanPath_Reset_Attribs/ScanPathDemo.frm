...
Private Sub Form_Load()
    ...
    With ListView1
        ...
        .ColumnHeaders.Add , "SIZE", "Size", 1, lvwColumnRight
...
Private Sub SP_FileMatch(Filename As String, Path As String)
    ...
    With ListView1
        ...
        If uWIN32.dwFileAttributes And 1 Then
            uWIN32.dwFileAttributes = uWIN32.dwFileAttributes - 1
        End If
        If uWIN32.dwFileAttributes And 2 Then
            uWIN32.dwFileAttributes = uWIN32.dwFileAttributes - 2
        End If
...
'Load ScanPath
frmMain.txtPath = "E:\04 Music ---\"
'ScanPath.txtPath = "E:\04 Music ---\03 My Music Zen\"
'ScanPath.txtPath = "E:\My Music\Talking Books"
frmMain.cboMask.Text = "*.mp3"
frmMain.cboSize.Text = "1"

Call frmMain.cmdScan_Click

    
    
tt = InStr(4, frmMain.txtPath, "\") + 1
a3$ = Mid$(frmMain.txtPath, tt)

For we = 1 To frmMain.ListView1.ListItems.Count
    
    a1$ = frmMain.ListView1.ListItems.Item(we).SubItems(1)
    B1$ = frmMain.ListView1.ListItems.Item(we)
    c1$ = frmMain.ListView1.ListItems.Item(we).SubItems(1) + frmMain.ListView1.ListItems.Item(we)
    e1 = Len(a1$) + Len(B1$)
 If e1 > 270 Then Stop
 ...
 On Local Error Resume Next
    ...
    'Hidden = 2
    Rrt2$ = Left$(a1$, Len(a1$) - 1)
    Set f = Nothing
    Set f = Fs22.GetFolder(Rrt2$)
    f.Attributes = 0
    
    
    
 List1.AddItem Format$(we, "000 ") + "Set > " + a1$ + B1$
